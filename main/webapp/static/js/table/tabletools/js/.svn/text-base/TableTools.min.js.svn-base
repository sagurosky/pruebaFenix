...
});g(D,C,"ToolTables_CSV_"+z,"Exportar a CSV")}function s(){var E="TableTools_button TableTools_xls";
...
});g(D,C,"ToolTables_XLS_"+z,"Exportar a Excel")}function B(){var E="TableTools_button TableTools_clipboard";
...
});D.addEventListener("complete",function(F,H){var G=f.split("\n");alert("Se ha"+((G.length-1)==1?"":"n")+" copiado "+(G.length-1)+" fila"+((G.length-1)==1?"":"s")+" al portapapeles")
});g(D,C,"ToolTables_Copy_"+z,"Copiar al portapapeles")}function d(){var D="TableTools_button TableTools_print";
var C=document.createElement("div");C.style.height=n.iButtonHeight+"px";C.style.width=n.iButtonWidth+"px";
C.className=D;C.title="Imprimir";_nTools.appendChild(C);a(C).hover(function(E){C.className=D+"_hover"
