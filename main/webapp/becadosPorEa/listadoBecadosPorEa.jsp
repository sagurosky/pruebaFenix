...
<table id="tContabilidad" class="display" cellspacing="0" width="100%">
    ...
    <%	
    	...
    	cn2 = null;
       	...
       	call2 = "{CALL SP_TraerBecaAsignadaPorEA(?,?)}";
    	cn2 = Conexion.getConexion();
        cl2 = cn2.prepareCall(call2); 
        cl2.setString(1,rs.getString("id") );
        //System.out.println("ea: "+rs.getString("id")+" "+rs.getString("apellido"));
        cl2.setString(2, fechaAnterior);
        rs2 = cl2.executeQuery();
        while (rs2.next()) {
        	total=total+ Long.parseLong(rs2.getString("becaAsignada"));
        	
        	ok="ok";
      %>  	
    	<td nowrap="nowrap" align="center"><%=rs2.getString("becaAsignada")%></td>    	
    <%}
