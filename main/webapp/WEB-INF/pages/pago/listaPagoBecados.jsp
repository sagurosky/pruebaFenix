...
<display:table class="displayTags_wrapper" export="true" style="font-size: 12px; margin-left: 50px; margin-right: 50px;" uid="pagos" id="pagosList" name="sessionScope.pagosList" pagesize='50' defaultsort="1" defaultorder="ascending" requestURI="">  
    <display:column property="becadoId" sortProperty="becadoId" sortable="true"  style="width: 18%" headerClass="sortable" title="id Becado" maxLength="50" />
    ...
    <display:column property="becado.datosPersonales.dni" sortProperty="becado.datosPersonales.dni" sortable="true"  style="width: 18%" headerClass="sortable" title="DNI Becado" maxLength="50" />
    ...
    <display:column property="responsable.cuilCuit" sortProperty="responsable.cuilCuit" sortable="true"  style="width: 10%" headerClass="sortable" title="CUIT" maxLength="25" />  
     <display:column property="responsable.nroCuenta" sortProperty="responsable.nroCuenta" sortable="true"  style="width: 10%" headerClass="sortable" title="Nro Cta" maxLength="25" />
