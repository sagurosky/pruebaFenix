...
<!--			-->
		...
		<tr>
		<td valign="top">Habilidades y/o contenidos *</td>
		<td >
			<form:select id="contenido" path="contenidosAbordados" multiple="true" cssClass="required"> 
				<form:options items="${tiposContenido}" itemLabel="valor" itemValue="id" />
			</form:select>
				<input id="contenidos" type="hidden" value="${evento.contenidosAbordados}"/>		
		</td>		
		</tr>
		<tr>
		<td valign="top">Otros Contenidos</td>
		<td >		
		...
		<tr>
		<td valign="top">Evaluacion General del Encuentro</td>
		<td >
