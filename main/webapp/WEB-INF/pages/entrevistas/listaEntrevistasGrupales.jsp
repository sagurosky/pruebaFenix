...
<script>
	function openDetalleEntrevistaGrupal2022(accion){
		//alert(accion);
		document.forms['entrevistaForm'].ide2.value = accion;
		//alert(document.forms['entrevistaForm'].ide2.value+1);
		document.forms['entrevistaForm'].action = "../entrevistas/verDetalleEntrevistaGrupalView.do";
		//alert(document.forms['entrevistaForm'].ide2.value+2);
		document.forms['entrevistaForm'].entrevistaId.value = accion;
		document.forms['entrevistaForm'].idObjeto.value = accion;
		//alert(document.forms['entrevistaForm'].ide2.value+3);
...
<script>
	function exportarFormTodo(action,id) {
		...
		//alert(document.getElementById("ciclo1").value);
		...
		document.forms['entrevistaForm'].ciclo.value=ciclo2;
		document.forms['entrevistaForm'].submit();
	}
...
<form id="entrevistaForm" class="entrevistaForm">
								...
								<tr>
									<td>
										<div  style= width:0.5cm class="ui-state-default ui-corner-all" > 
											<a onclick="openDetalleEntrevistaGrupal2022('${e.id}');">
	...
	<input type="hidden" id="ide2" name="ide2" value="${e.id}">
	<input type="hidden" id="idObjeto" name="idObjeto" value="${e.id}">
</form>
</div>
