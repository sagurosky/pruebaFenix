...
<div class="col-lg-10">
	...
	<div class="form-group form-inline">
		<label class="text-danger">Actualización Situación Escolar 2020 ¿Cuál fue el resultado escolar del ciclo 2020? &nbsp;&nbsp;</label>
		<select  class="form-control"  id="motivoAusenciaRa2" name="motivoAusenciaRa2" style='width:auto'>
			<c:choose>
			    ...
			    <c:when test="${entrevista.motivoAusenciaRa2 == 'Repitió'}">
      						<option value='0'>Seleccione una opci&oacute;n:</option>
	...
	<c:if test="${entrevista.periodoDePago.nombre=='Julio' || periodo.nombre=='Julio' }">
		<div class="form-group form-inline">
			<label>Evaluación del compromiso del EP con el programa &nbsp;&nbsp;</label>			
		...
		<div class="form-group form-inline">
			<label>Evaluación del compromiso del RA con el programa &nbsp;&nbsp;</label>			
	...
	<c:if test="${entrevista.periodoDePago.nombre=='Julio' || periodo.nombre=='Julio' }">
		<div class="form-group form-inline">
			<label> Seguimiento del propósito anual y desafíos a trabajar en el segundo semestre &nbsp;&nbsp;</label>			
		...
		<div class="form-group form-inline">
			<label class="text-danger">¿Qué trabajaste en el acompañamiento<br>en esta primer parte del año? &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</label>			
	...
	<div class="form-group form-inline">
		<c:choose>
		   	<c:when test="${entrevista.periodoDePago.nombre=='Julio' || periodo.nombre=='Julio' }">
				<label class="text-danger">Observaciones sobre rendimiento escolar<br>y asistencia en esta primera parte del año  &nbsp;&nbsp;</label>					
			</c:when>
			<c:otherwise>		
	...
	<div class="form-group form-inline">
		<c:choose>
		   	<c:when test="${entrevista.periodoDePago.nombre=='Julio' || periodo.nombre=='Julio' }">
				<label class="text-danger">Principal HSE trabajada en esta primer parte del año  &nbsp;&nbsp;</label>		
			</c:when>
			<c:otherwise>
		...
		<select  name="hsTrabajarAño" id="hsTrabajarAño" style='width:auto' class="form-control"> 
			<c:choose>
  				<c:when test="${entrevista.hsTrabajarAño == 'Autoconcepto,0'}">
    				<option value="0">Seleccione una opci&oacute;n:</option>
			    ...
			    <c:when test="${entrevista.hsTrabajarAño == 'Planificación y organización del tiempo,0'}">
    				<option value="0">Seleccione una opci&oacute;n:</option>
			    ...
			    <c:when test="${entrevista.hsTrabajarAño == 'Relaciones interpersonales,0'}">
    				<option value="0">Seleccione una opci&oacute;n:</option>
					<option value="Autoconcepto">Autoconcepto</option>
					<option Value="Planificación y organización del tiempo">Planificación y organización del tiempo</option>									
			    ...
			    <c:when test="${entrevista.hsTrabajarAño == 'Responsabilidad y autonomía,0'}">
     				<option value="0">Seleccione una opci&oacute;n:</option>
					<option value="Autoconcepto">Autoconcepto</option>
					<option Value="Planificación y organización del tiempo">Planificación y organización del tiempo</option>									
					<option Value="Relaciones interpersonales" >Relaciones interpersonales</option>
			    ...
			    <c:when test="${entrevista.hsTrabajarAño == 'Toma de decisiones,0'}">
     				<option value="0">Seleccione una opci&oacute;n:</option>
					<option value="Autoconcepto">Autoconcepto</option>
					<option Value="Planificación y organización del tiempo">Planificación y organización del tiempo</option>									
					<option Value="Relaciones interpersonales" >Relaciones interpersonales</option>
			    ...
			    <c:when test="${entrevista.hsTrabajarAño == 'Otra,0'}">
     				<option value="0">Seleccione una opci&oacute;n:</option>
					<option value="Autoconcepto">Autoconcepto</option>
					<option Value="Planificación y organización del tiempo">Planificación y organización del tiempo</option>									
					<option Value="Relaciones interpersonales" >Relaciones interpersonales</option>
	...
	<div class="form-group form-inline">
		<c:choose>
			<c:when test="${entrevista.periodoDePago.nombre=='Julio' || periodo.nombre=='Julio' }">
				<label>Principales Contenidos trabajados en esta primer parte del año  &nbsp;&nbsp;</label>
			</c:when>
			<c:otherwise>			
	...
	<c:if test="${entrevista.periodoDePago.nombre=='Julio' || periodo.nombre=='Julio' }">	
		...
		<div class="form-group form-inline">	
			<label class="text-danger">¿El EP participó del Apoyo Escolar Virtual? &nbsp;&nbsp;</label>			
			<form:checkbox path="brujula" id="brujula" style='width:auto' class="form-control" />
		</div>
	</c:if>
		...
		<c:if test="${(egreso==2021 || egreso==2022) && (entrevista.periodoDePago.nombre=='Julio' || periodo.nombre=='Julio') }">
			<div class="card bg-light text-dark">
    			<div class="card-body">Egreso: ${egreso} 						
					...
					<div class="form-group form-inline">
						<label>Especificar área de estudios, si lo sabe &nbsp;&nbsp;</label>								
						<select id="ie" name="ie" style='width:auto' class="form-control">				
			  				<c:choose>
			   					<c:when test="${entrevista.ie == 'Agronomía'}">
									<option value="0" >Seleccione una opción</option>
									<option value="Agronomía" selected="selected">Agronomía</option>
									<option value="Arquitectura">Arquitectura</option>
									<option value="Ciencias Económicas, marketing y negocios">Ciencias Económicas, marketing y negocios</option>
								...
								<c:when test="${entrevista.ie == 'Ciencias Económicas, marketing y negocios'}">
									<option value="0" >Seleccione una opción</option>
									<option value="Agronomía">Agronomía</option>
									<option value="Arquitectura">Arquitectura</option>
									<option value="Ciencias Económicas, marketing y negocios"  selected="selected">Ciencias Económicas, marketing y negocios</option>
									<option value="Ciencias exactas y naturales">Ciencias exactas y naturales</option>
									<option value="Ciencias sociales, arte y humanidades">Ciencias sociales, arte y humanidades</option>
									<option value="Derecho">Derecho</option>
									<option value="Ingeniería">Ingeniería</option>
								...
								<c:when test="${entrevista.ie == 'Ingeniería'}">
									<option value="0" >Seleccione una opción</option>
									<option value="Agronomía">Agronomía</option>
									<option value="Arquitectura">Arquitectura</option>
									<option value="Ciencias Económicas, marketing y negocios">Ciencias Económicas, marketing y negocios</option>
								...
								<c:when test="${entrevista.ie == 'Psicología'}">
									<option value="0" >Seleccione una opción</option>
									<option value="Agronomía">Agronomía</option>
									<option value="Arquitectura">Arquitectura</option>
									<option value="Ciencias Económicas, marketing y negocios">Ciencias Económicas, marketing y negocios</option>
									...
									<option value="Ingeniería">Ingeniería</option>
									<option value="Medicina y Ciencias de la salud">Medicina y Ciencias de la salud</option>
									<option value="Psicología" selected="selected">Psicología</option>
									<option value="Otra">Otra</option>
								</c:when>
	...
	<c:if test="${!entrevista.periodoDePago.nombre=='Julio' || !periodo.nombre=='Julio' }">	
		<label>Observac.sobre alumnos<br>renovados p/excepción</label>			
...
function guardarAprobar(valor, valorPerfil){		
	...
	if(document.forms['altaEntrevistaIndividual'].periodo.value=="Julio"){
		...
		if(document.forms['altaEntrevistaIndividual'].qtam.value==""){					
			texto=texto+"<li>¿Qué trabajaste en el acompañamiento en esta primer parte del año?</li>";
		}
