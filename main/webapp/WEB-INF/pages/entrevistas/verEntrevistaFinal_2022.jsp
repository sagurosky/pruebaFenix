		...
		if (document.forms['altaEntrevistaIndividual'].evaluacionCobroBeca.value == 3 ) { 
			...
			if (valor == 'f' || valor == 's'){
				...
				if(document.forms['altaEntrevistaIndividual'].osme.value==""){			
					jAlert('warning', 'Falta completar Observaciones sobre rendimiento escolar y asistencia durante la 2º parte del año', 'Atención!');  
					return false;	
				}
				...
				if(document.forms['altaEntrevistaIndividual'].contenidosTrabajarEnElAnio.value=="0"){			
					jAlert('warning', 'Falta completar Contenidos Abordados', 'Atención!');  
					return false;	
				}
				if(document.forms['altaEntrevistaIndividual'].qtam.value==""){			
					jAlert('warning', 'Falta completar Qué trabajaste en el acompañamiento en esta 2º parte del año', 'Atención!');  
					return false;	
				}
				...
				if(document.forms['altaEntrevistaIndividual'].materiasRendirDiciembre.value==""){			
					jAlert('warning', 'Falta completar Materias/fechas a rendir en diciembre ', 'Atención!');  
					return false;	
				}
				if(document.forms['altaEntrevistaIndividual'].materiasRendirFebMarzo.value==""){			
					jAlert('warning', 'Falta completar Materias/fechas a rendir en febrero/marzo ', 'Atención!');  
					return false;	
				}
				if(document.forms['altaEntrevistaIndividual'].motivoInasistenciaR.value=="0"){			
					jAlert('warning', 'Falta completar Principal motivo de inasistencias ', 'Atención!');  
					return false;	
				}
				...
				if(document.forms['altaEntrevistaIndividual'].sarpepe.value=="0"){			
					jAlert('warning', 'Falta completar Proyección post-escolar del EP', 'Atención!');  
					return false;	
				}
				if(document.forms['altaEntrevistaIndividual'].te.value=="0"){			
					jAlert('warning', 'Falta completar En caso que quiera estudiar, qué estudios quiere hacer? ', 'Atención!');  
					return false;	
				}								
...
<br>
<div class="form-group">
	<label>Valoración compromiso EP con el Programa &nbsp;&nbsp;</label><br>			
...
<br>
<div class="form-group">
	<label>Valoración Compromiso RA con el Programa &nbsp;&nbsp;</label><br>			
...
<br>		
<div class="form-group">
	<label>Seguimiento de Propósito anual &nbsp;&nbsp;</label>			
...
<div class="form-group">
	<label class="text-danger">Observaciones sobre<br>la trayectoria pedagógica<br>y participación durante<br>la 2da parte de año</label>
...
<div class="form-group form-inline">		
	<label class="text-danger">Principal HSE trabajada en esta segunda parte del año  &nbsp;&nbsp;</label>				
...
<div class="form-group form-inline">
	<label class="text-danger">Principal Contenido trabajado durante la 2da parte del año  &nbsp;&nbsp;</label>			
...
<div class="form-group form-inline">
	<label class="text-danger">Otro contenido trabajado &nbsp;&nbsp;</label>										
...
<c:if test="${egreso==0}">
	<div class="card bg-light text-dark">
		...
		<div class="form-group form-inline">	
			<label class="text-danger">&nbsp;&nbsp; Dirección de mail  &nbsp;&nbsp;</label>										
...
<div class="form-group form-inline">
	<label class="text-danger">Ampliar información sobre la situación de riesgo seleccionada &nbsp;&nbsp;</label>												   					
...
<c:if test="${egreso!=0}">
	<div class="form-group form-inline">
		<label class="text-danger">Motivo de no renovación &nbsp;&nbsp;</label>	
			<form:select path="motivoNoRenovacion" id="motivoNoRenovacion" style='width:auto' class="form-control required">
				<form:option value="">Seleccione una opcion...</form:option>
