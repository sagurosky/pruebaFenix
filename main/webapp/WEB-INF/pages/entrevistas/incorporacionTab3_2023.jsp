...
<table id="table-informe">
	...
	<tr>
		<td><label>Otro contenido trabajado &nbsp;&nbsp;</label></td>	
		<td>
	...
	<tr>
		<td nowrap="nowrap"><label>Situación de Riesgo-Extra Escolar</label></td>
		<td>			
	...
	<tr>
		<td nowrap="nowrap"><label>Situación de Riesgo Escolar</label></td>
		<td>			
			<form:select path="situacionRiesgoEscolar" class="textbox2">
