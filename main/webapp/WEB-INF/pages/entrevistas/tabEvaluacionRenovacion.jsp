...
<table id="table-informe">
	...
	<tr>
		...
		<td>
			<form:select path="motivoPendiente" id="motivoPendiente" readonly="readonly"  class="textbox2" onchange="habilitarMotivoPendiente(this)">
				<form:option value="">Seleccione una opción...</form:option>
	...
	<tr>
		...
		<td>
			<form:select path="motivoNoRenovacion" id="motivoNoRenovacion" class="textbox2" readonly="readonly">
				<form:option value="">Seleccione una opción...</form:option>
				<form:options items="${motivoNoRenovacion}" itemLabel="valor" itemValue="id"/>				
			</form:select><font size="1">Atención. Este campo aparece en Informe al padrino.</font><img src="../static/images/atencion.gif" width=10>
			<input type="hidden" name="obsMateriasPendientes" id="obsMateriasPendientes" value="">
