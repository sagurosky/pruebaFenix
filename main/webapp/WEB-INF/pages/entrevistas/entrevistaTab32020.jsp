...
<table id="table-informe">
	...
	<c:if test="${entrevista.periodoDePago.nombre=='Julio' || periodo.nombre=='Julio' }">
		...
		<td>
			<form:select path="contenidosTrabajarDuranteAnio" id="contenidosTrabajarDuranteAnio" class="textbox2 required">
				<c:choose>
		...
		<tr>	
			<td>			
				<c:set var="isGrupal" value="true"></c:set>
					<b>Objetivo del encuentro y temas<br>desarrollados *</b>:<br>												   					
			</td>
