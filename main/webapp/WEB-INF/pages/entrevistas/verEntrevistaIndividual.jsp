...
<div class="row">
	...
	<c:choose>
 		<c:when test="${entrevista.periodoDePago.nombre=='Julio' || periodo.nombre=='Julio' }">
			...
			<div class="card bg-info text-white"> 
					<div class="card-body">Acompañamiento - Semestral - <font color="red">Atención, esta información se Incluye en el Informe de Seguimiento!</font> </div>
			</div>
			<br>
			<div class="form-group form-inline">
		...
		<div class="jumbotron">
			...
			<br>
			<div class="form-group form-inline">
				<label class="text-danger">Asistencia a la modalidad de cursada definida &nbsp;<br>por la escuela (virtual y/o presencial) &nbsp;&nbsp;</label>								
			...
			<div class="form-group form-inline">
				<label class="text-danger">Cumplimiento con las tareas asignadas por la &nbsp;<br> escuela &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</label>				
			...
			<div class="form-group form-inline">
				<label class="text-danger">Pone en juego estrategias para resolver &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<br>dificultades escolares &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</label>				
			...
			<div class="form-group form-inline">
				<label class="text-danger">Compromiso activo para rendir materias &nbsp;<br>pendientes escolares &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</label>				
			...
			<div class="form-group form-inline">
				<label class="text-danger">Rendimiento escolar en esta etapa del año &nbsp;&nbsp;&nbsp;&nbsp;<br>escolar &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</label>				
			...
			<div class="form-group form-inline">
				<label class="text-danger">Apropiación de las Habilidades&nbsp;<br>Socioemocionales trabajadas en el&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<br>acompañamiento</label>				
			...
			<div class="form-group form-inline">
				<label class="text-danger">Compromiso para el cumplimiento de los&nbsp;<br>propósitos establecidos en el&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<br> acompañamiento &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</label>				
			...
			<div class="form-group form-inline">
				<label class="text-danger">Asistencia y participación del Responsable&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<br>Adulto en los espacios de&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<br>acompañamiento &nbsp;&nbsp;&nbsp;&nbsp;</label>				
		...
		<div class="form-group form-inline">
			<label class="text-danger">Materias Pendientes: 			
			<c:choose>
		...
		<div class="form-group form-inline">
			<label class="text-danger">Suspensiones: ${entrevista.sus} &nbsp;&nbsp;</label>
			<br><br>
			<label>Atención. Esta información se incluye en el Informe de Seguimiento<img src="../static/images/atencion.gif" width=10></label>				
		...
		<br>
		<div class="card bg-info text-white">
    			<div class="card-body">información general</div>
  		</div>
