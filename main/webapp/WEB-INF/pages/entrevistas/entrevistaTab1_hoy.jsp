			...
			<table  width="900" border=1>
				<c:if test="${periodo.nombre=='Septiembre'}">						
					<c:if test="${alumno.situacionEscolar=='PROMOVIDO_CON_PREVIAS'}">
						<tr>
							<td colspan="2"><b><img src="../static/images/atencion.gif" width=10><font color="red"  size="2">¡Atención! Recordá actualizar el registro de materias previas para este alumno en su boletín del ciclo actual</font></b> </td>
						</tr>						
						<tr>
							<td colspan="2"><b><font color="red"  size="2">(si aún no lo generaste, deberás hacerlo desde tu panel).</font></b></td>
						</tr>	
					</c:if>		 
				</c:if>
				...
				<c:if test="${periodo != null && entrevista.periodoDePago == null}">
					<tr>		
						<td width="500" nowrap="nowrap"><label>Periodo Espacio de acompañamiento</label>
							<br>
							<label><b>${periodo.nombre}</b></label>
						</td>
						
						
						<td width="500"><label>Fecha De Incorporación al PFE</label>
							<label><b><fmt:formatDate value="${alumno.fechaPBE}" pattern="dd/MM/yyyy"/></b></label>
						</td>
				...
				<c:if test="${entrevista.periodoDePago != null}">
					<tr>		
						<td><label>Periodo Espacio de acompañamiento</label><br>
							<label><b>${entrevista.periodoDePago.nombre}</b></label>
						</td>
						<td ><label>Fecha De Incorporación al PFE</label><br>
							<label><b><fmt:formatDate value="${alumno.fechaPBE}" pattern="dd/MM/yyyy"/></b></label>
						</td>
					</tr>	
				</c:if>
				...
				<tr>
					<td><label>Principal tipo encuentro acompañamiento:</label>
					...
					<td ><label>Tuvo más de un Encuentro de acompañamiento en el mes?</label>
						<br>
						<select id="masDeUnEncuentro" name="masDeUnEncuentro" class="textbox2">							
							<c:choose>
				...
				<tr>	
					<td><label>Participó Becado  *</label><br>
						...
						<select id="participoBecado" name="participoBecado" class="textbox2">							
							<c:choose>
					...
					<td><label>Motivo Ausencia *</label><br>					
						<!-- select name="motivoAusencia" id="motivoAusencia" class="required"-->
						<form:select path="motivoAusencia" id="motivoAusencia" class="textbox2 required">
								<c:choose>
				...
				<tr>
					<td><label>Otro Motivo</label><br>					
						<form:textarea path="otroMotivoAusencia" id="otroMotivoAusencia"   rows="4" cols="50" onblur="chequearLongitud(this);" onkeypress="chequearLongitud(this);" disabled="false" class="textbox2" />
					</td>
				
					<td><label>Participación RA *</label><br>
						...
						<select id="motivoAusenciaRa2" name="motivoAusenciaRa2" class="textbox2">
							<c:choose>
