...
<td style="vertical-align: top">
	...
	<div class="ui-state-default ui-corner-all" align="center">
		<h3 align="center">Lista de Espacio de acompañamiento</h3>
	</div>
	<!-- Fin titulo -->
...
<table align="center">
	<tr>
		<td>
			<c:if test="${tipoEntrevista == 'mensual'}">
				<input type="submit" value="Alta Ent. Mensual" class="ui-state-default ui-corner-all" onclick="window.location.href='../entrevistas/registrarEntrevistasView.do?tipo=m&idAlumno=' + ${alumno.id}" />
			</c:if>
			<c:if test="${tipoEntrevista == 'final'}">			
				<input type="submit" value="Alta Ent. Final" class="ui-state-default ui-corner-all" onclick="window.location.href='../entrevistas/registrarEntrevistasView.do?tipo=f&idAlumno=' + ${alumno.id}" />
			</c:if>
			<c:if test="${tipoEntrevista == 'renovacion'}">
				<input type="submit" value="Alta Ent. Renovacion" class="ui-state-default ui-corner-all" onclick="window.location.href='../entrevistas/registrarRenovacionView.do?idAlumno=' + ${alumno.id}" />
			</c:if>
			<c:if test="${tipoEntrevista == 'incorporacion'}">
				<input type="submit" value="Alta Ent. Incorporacion" class="ui-state-default ui-corner-all" onclick="window.location.href='../entrevistas/registrarIncorporacionView.do?idAlumno=' + ${alumno.id}" />
			</c:if>		
		</td>
	</tr>
</table>
