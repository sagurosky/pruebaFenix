...
<form:hidden path="periodoDePago"/>
	<div class="card-body p-3 my-3 bg-secondary text-white">
		  <h3 title="IdAlumno=${alumno.id}">Espacio de acompañamiento Febrero - ${periodo.nombre} ${periodo.ciclo.nombre}  ${entrevista.periodoDePago.nombre} ${entrevista.periodoDePago.ciclo.nombre} - ${entrevista.estadoEntrevista.valor}<br>${alumno.datosPersonales.nombre}&nbsp;${alumno.datosPersonales.apellido}</h3>
			...
			<c:if test="${alumno.escuela.zonaCimientos.eae=='6/6'}">
		    	<c:if test="${alumno.anioAdicional}">
					${2020+14-alumno.anioEscolar.id+1} 
				</c:if>
				<c:if test="${!alumno.anioAdicional}">					
					<c:if test="${alumno.anioEscolar.valor=='6º secundaria'}">
						${2020+14-alumno.anioEscolar.id} 
					</c:if>
					<c:if test="${alumno.anioEscolar.valor!='6º secundaria'}">
						${2020+14-alumno.anioEscolar.id}
					</c:if>
...
<br>
<div class="form-group">
	<label class="text-danger">Valoración compromiso EP con el Programa &nbsp;&nbsp;</label><br>			
...
<br>
<div class="form-group">
	<label class="text-danger">Valoración Compromiso RA con el Programa &nbsp;&nbsp;</label><br>			
