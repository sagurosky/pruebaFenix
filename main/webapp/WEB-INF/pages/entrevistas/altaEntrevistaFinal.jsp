		...
		if (document.forms['altaEntrevistaIndividual'].evaluacionCobroBeca.value == 3 ) { 
			...
			if (valor == 'f' || valor == 's'){
				...
				if(document.forms['altaEntrevistaIndividual'].tarang.value==""){					
					jAlert('warning', 'Trabajo de acompañamiento realizado a nivel grupal', 'Atención!');
					return false
				}
				
				if(document.forms['altaEntrevistaIndividual'].paa.value==""){					
					jAlert('warning', 'Propósito Anual de Acompañamiento', 'Atención!');
					return false
				}
				
				if(document.forms['altaEntrevistaIndividual'].iatarni.value==""){					
					jAlert('warning', 'Trabajo de Acompañamiento realizado a nivel individual', 'Atención!');
					return false
				}
				...
				if(document.forms['altaEntrevistaIndividual'].anioEgreso.value=="2023"){
					if(document.forms['altaEntrevistaIndividual'].dirMail.value==""){			
						jAlert('warning', 'Falta completar Dirección de mail ', 'Atención!');  
						return false;	
					}
...
<div class="form-group form-inline">
	<label class="text-danger">¿Participó el becado?</label>																				
...
<br>
<div class="card bg-info text-white">
		<div class="card-body">Acompañamiento Semestral - Atención, esta información se Incluye en el Informe de Seguimiento! </div>
</div>
<br>
...
<div class="jumbotron">
			...
			<div class="form-group form-inline">
				<label>Compromiso activo para rendir materias &nbsp;<br>pendientes escolares de años anteriores &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</label>				
...
<br>
<div class="form-group form-inline">
			<label class="text-danger">Trabajo de Acompañamiento realizado a nivel individual &nbsp;&nbsp;</label>
...
<br>
<div class="form-group form-inline">	
			<label>¿Usaste el fichero en esta segunda parte del año? &nbsp;&nbsp;</label>			
		...
		<div class="form-group form-inline">	
			<label>¿Completaste la brújula con el EP en esta segunda parte del año? &nbsp;&nbsp;</label>					
...
<input type="hidden" name="estadoIS3" id="estadoIS3" value="0"></input>
