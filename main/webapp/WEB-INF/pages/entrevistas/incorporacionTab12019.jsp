		...
		<td>
			<table id="table-informe">
				...
				<tr>
					...
					<td>
						<form:textarea path="otroMotivoAusencia" id="otroMotivoAusencia" disabled="true" class="textbox2" rows="4" cols="30" onblur="chequearLongitud(this);" onkeypress="chequearLongitud(this);"/>
					</td>
				</tr>
				<tr>
					...
					<td>						
						...
						<input type="text" id="raNoConvocado" name="raNoConvocado" value="${entrevista.raNoConvocado}">
				...
				<tr>
					<td><label>Participó RA *</label></td>
					<td>
