...
<table id="table-informe">
	...
	<c:if test="${!entrevista.periodoDePago.nombre=='Julio' || !periodo.nombre=='Julio' }">
			<tr>			
				...
				<td>
					<select id="cpaEA" name="cpaEA"  disabled="true">
	...
	<c:if test="${entrevista.periodoDePago.nombre=='Julio' || periodo.nombre=='Julio' }">
		<tr>
			...
			<td>
				<form:textarea path="propositoAnual"  id="propositoAnual" class="textbox2" rows="4" cols="60" onblur="chequearLongitud(this);" onkeypress="chequearLongitud(this);"  disabled="true"/>											
			</td>											   		
			</tr>
		</c:if>
	...
	<c:if test="${!entrevista.periodoDePago.nombre=='Julio' || !periodo.nombre=='Julio' }">
		<tr>
			...
			<td>
				<form:textarea path="ossr" rows="4" cols="60" onblur="chequearLongitud(this);" onkeypress="chequearLongitud(this);" disabled="true"/>
			</td>
		</tr>
	</c:if>	
	<tr>
		...
		<td>
			<form:textarea path="osme" rows="4" cols="60" onblur="chequearLongitud(this);" onkeypress="chequearLongitud(this);"  disabled="true"/>
		</td>
	</tr>
	<c:if test="${entrevista.periodoDePago.nombre=='Julio' || periodo.nombre=='Julio' }">	
		<tr>
	...
	<c:if test="${!entrevista.periodoDePago.nombre=='Julio' || !periodo.nombre=='Julio' }">	
		<tr>
			...
			<td>
				<form:textarea path="osare" rows="4" cols="60" onblur="chequearLongitud(this);" onkeypress="chequearLongitud(this);" disabled="true"/>
			</td>
		</tr>
	</c:if>
	...
	<c:if test="${entrevista.periodoDePago.nombre=='Julio' || periodo.nombre=='Julio' }">
		...
		<td>
			<form:select path="hsTrabajarAño" id="hsTrabajarAño" class="textbox2"  disabled="true"> 
				<c:choose>
		...
		<td>
			<form:select path="contenidosTrabajarDuranteAnio" id="contenidosTrabajarDuranteAnio" class="textbox2"  disabled="true">
				<c:choose>
		...
		<tr>	
			...
			<td>
				<form:checkbox path="usasteFichero" id="usasteFichero"  disabled="true"/>
			</td>
		</tr>
		<tr>	
			<td><label>Completaste la brújula?</label></td>
			<td>
				<form:checkbox path="brujula" id="brujula"  disabled="true"/>
			</td>
		</tr>
		<tr>
			...
			<td>
				<form:textarea path="qtam" rows="4" cols="60" onblur="chequearLongitud(this);" onkeypress="chequearLongitud(this);" disabled="true"/>
		...
		<c:if test="${egreso==2018}">
			...
			<tr>
				...
				<td>						
					<form:textarea path="ie" rows="4" cols="70" onblur="chequearLongitud(this);" onkeypress="chequearLongitud(this);" disabled="true"/>					
				</td>				
			</tr>
			<tr>	
	...
	<td nowrap="nowrap" valign="top"><label>Evaluacion Cobro Beca  *</label></td>
		<td>
		<form:select path="evaluacionCobroBeca" id="evaluacionCobroBeca" class="required" onchange="habilitarMotivos(this)" disabled="true">
	...
	<tr>		
		...
		<td>
			<form:select path="motivoCesacion" id="motivoCesacion"  class="required"  disabled="true">
				<form:option value="">Seleccione una opción...</form:option>
		...
		<tr>	
			<td>			
					...
					<b>Objetivo del encuentro y temas<br>desarrollados en el Encuentro Grupal</b>:<br>												   					
			</td>
			<td>${entrevista.objetivoEncuentro}
			</td>			
		</tr>	
	...
	<tr>		
		...
		<td>
			<form:checkbox path="pagaEntrevista" checked="checked" disabled="true"/>
		</td>
	</tr>
	</c:if>
	<tr>
		...
		<td>
			<form:textarea path="comentariosRevision" rows="4" cols="60" onblur="chequearLongitud(this);" onkeypress="chequearLongitud(this);" disabled="true"/>
		</td>
	</tr>
</table>