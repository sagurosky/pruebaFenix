...
<table id="table-informe">
	...
	<tr>	
		<td nowrap="nowrap"><label>Presenta Certificado Alumno Regular? *</label></td>
		<td>
			<form:select path="certificadoAlumnoRegular" id="certificadoAlumnoRegular" class="textbox2" 
	...
	<tr>		
		<td><label>Presenta Fotocopia Boletin?  *</label></td>
		<td>
			<form:select path="fotocipiaBoletin" id="fotocipiaBoletin" class="textbox2"
	...
	<tr>		
		<td><label>Firma Acta de Compromiso?  *</label></td>
		<td>
	...
	<tr>	
		<td nowrap="nowrap"><label>Firma Autorizacion Cierre Cta Bco?  *</label></td>
		<td>
	...
	<tr>		
		<td nowrap="nowrap" ><label>Firma Autorizacion de Imagen?  *</label></td>
		<td>
	...
	<tr>		
		<td nowrap="nowrap" width="32%"><label>Presenta Material Completo? *</label></td>
		<td>
