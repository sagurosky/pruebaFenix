	...
	<tr>
		<td>
			<table id="table-informe">
				...
				<tr>
					<td nowrap="nowrap"><label>Tipo encuentro<br>acompañamiento:</label></td>					
						<td>
...
<h3  class="ui-accordion-header  ui-state-default ui-corner-all"  align="left" ><a href="#" onclick="mostrar(2)" >Datos Bancarios</a> (si los datos no coinciden con la información que brinda el RA, avisar a su RR para evitar demoras en la apertura de cuentas)</h3>
	<div id="datosEntrevista2"  style=" height:200px; ;overflow:scroll;">  	
		<table id="table-informe">
			<tr>
					<td colspan="2">
				...
				<tr>
					...
					<c:forEach var="name" items="${q1.rows}">
						<c:out value="${name.apellido}"/>, <c:out value="${name.nombre}"/>					
					
					</td>
				</tr>
				<tr>
					<td><strong>DNI Titular</strong></td>
					<td><c:out value="${name.dni}"/></td>	
				</tr>
				<tr>
					<td><strong>CUIL Titular</strong></td>
					<td><c:out value="${name.cuil_cuit}"/></td>	
				</tr>
				<tr>
					<td><strong>Fecha Nacimento Titular</strong></td>
					<td><c:out value="${name.fecha_nacimiento}"/></td>
				</tr>

				<tr>
					<td><strong>Vínculo</strong></td>
					<td>
					${alumno.responsable1.idVinculo.valor}
					</td>
