...
<div id="main-content">
<br>
<h1 align="center" id="titulo-informe">Bolet&iacute;n de : ${alumno.datosPersonales.apellido}&nbsp;${alumno.datosPersonales.nombre}</h1>
<form id="modificarBoletin" class="cmxform" action="<c:url value='/entrevistas/modificarDatosBoletin.do' />" method="post" enctype='multipart/form-data'>
    ...
    <tr>
      <td>
		...
		<c:if test="${empty urlInforme}">
				<tr >
					<td>
						<label>Inasistencias Primer Trimestre / Cuatrimestre:</label>
					</td>
					<td>			
					...
					<td>			
						<input size="13" maxlength="5"  type="hidden" name="diasHabilesPrimer" id="diasHabilesPrimer" class="text-input required digits" value="${boletin.diasHabilesPrimerTrimestre}" onkeypress="return validarDecimal(event, this);" onblur="validarInasistenciasYDias();"/>
					</td>
					<td>
						
						<input id="sinDatoHab1" type="hidden" <c:if test='${boletin.diasHabilesPrimerTrimestre == null}'> checked="checked" </c:if> />
					</td>					
				</tr>
				<tr>
					<td>
						<label>Inasistencias Segundo Trimestre / Cuatrimestre:</label>
					</td>
					<td>						
					...
					<td>						
						<input size="13" maxlength="5"  type="hidden" name="diasHabilesSegundo" id="diasHabilesSegundo" class="text-input required"  value="${boletin.diasHabilesSegundoTrimestre}" onkeypress="return validarDecimal(event, this);" onblur="validarInasistenciasYDias();" />
					</td>
					<td>
						
						<input id="sinDatoHab2" type="hidden" <c:if test='${boletin.diasHabilesSegundoTrimestre == null}'> checked="checked" </c:if> />
					</td>					
				</tr>
				<tr >
					<td>
					...
					<td>						
						<input size="13" maxlength="5"  type="hidden" name="diasHabilesTercer" id="diasHabilesTercer" class="text-input required" value="${boletin.diasHabilesTercerTrimestre}"  onkeypress="return validarDecimal(event, this);" onblur="validarInasistenciasYDias();"/>
					</td>
					<td>
						
						<input id="sinDatoHab3" type="hidden" <c:if test='${boletin.diasHabilesTercerTrimestre == null}'> checked="checked" </c:if> />
					</td>					
				</tr>
		</c:if>
				...
				<tr>
					<td nowrap="nowrap">
						<input type="hidden" id="conductaPrimer" name="conductaPrimer" value="3">
						<input type="hidden" id="conductaSegundo" name="conductaSegundo" value="3">
						<input type="hidden" id="conductaTercer" name="conductaTercer" value="3">
		...
		<tr>
		<td><h1 align="left" id="titulo-informe">Materias</h1></td>
		</tr>		
		<tr>
		<td >
    ...
    <tr>
    <td>
		<h1 align="left" id="titulo-informe">Cuadro de Previas</h1>
