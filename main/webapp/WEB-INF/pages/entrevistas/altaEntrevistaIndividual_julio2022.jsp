...
<div class="col-lg-10">
	...
	<div class="form-group form-inline">
		...
		<select  class="form-control"  id="ase2020" name="ase2020" style='width:auto'>
			<c:choose>
				<c:when test="${entrevista.ase2020 == 'Promovido sin adeudar materias'}">
      						<option value='0'>Seleccione una opci&oacute;n:</option>
			    ...
			    <c:when test="${entrevista.ase2020 == 'Promovido con materias a rendir'}">
      						<option value='0'>Seleccione una opci&oacute;n:</option>
			    ...
			    <c:when test="${entrevista.ase2020 == 'Repitió'}">
      						<option value='0'>Seleccione una opci&oacute;n:</option>
						<option value='Promovido sin adeudar materias'>Promovido sin adeudar materias</option>
						<option value='Promovido con materias a rendir' >Promovido con materias a rendir</option>
	...
	<c:if test="${entrevista.periodoDePago.nombre=='Julio' || periodo.nombre=='Julio' }">
		<div class="form-group form-inline">
			<label class="text-danger">Seguimiento del propósito anual y desafíos a trabajar en el segundo semestre &nbsp;&nbsp;</label>			
	...
	<c:if test="${entrevista.periodoDePago.nombre=='Julio' || periodo.nombre=='Julio' }">
		<div class="form-group form-inline">
			<label class="text-danger">Información adicional sobre las materias pendientes &nbsp;&nbsp;</label>			
			<form:textarea path="iamp" class="form-control" name="iamp" id="iamp" rows="4" cols="60" onblur="chequearLongitud(this);" onkeypress="chequearLongitud(this);"/>										
			<font size="1">Atención. Este campo va al Informe al padrino.</font><img src="../static/images/atencion.gif" width=10>
		</div>
	</c:if>
	...
	<c:if test="${entrevista.periodoDePago.nombre=='Julio' || periodo.nombre=='Julio' }">	
		...
		<div class="form-group form-inline">	
			...
			<select  class="form-control"  id="av" name="av" style='width:auto'>
				<c:choose>
					<c:when test="${entrevista.av == '1'}">      					
							<option value='1' selected="selected">Si</option>
							<option value='0' >No</option>
							 	
				    </c:when>													    
				    <c:when test="${entrevista.av == '0'}">	      					
							<option value='1'>Si</option>
							<option value='0'  selected="selected">No</option>
...
function guardarAprobar(valor, valorPerfil){		
	...
	if(document.forms['altaEntrevistaIndividual'].periodo.value=="Julio"){
		...
		document.forms['altaEntrevistaIndividual'].qtam.value="";
