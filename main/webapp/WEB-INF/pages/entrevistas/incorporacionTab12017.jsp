			...
			<table id="table-informe">
				...
				<tr>
					<td class="datepicker" nowrap="nowrap"><label>Fecha De
							Incorporacion al PFE</label></td>
					<td nowrap="nowrap"><label><b><fmt:formatDate
									value="${alumno.fechaPBE}" pattern="dd/MM/yyyy" /></b></label></td>
				</tr>
				<tr>
					<td class="datepicker" nowrap="nowrap"><label>Fecha
							Entrevista *</label></td>
					<td nowrap="nowrap"><input name="fechaEntrevista"
						id="datepicker" class="required"
						value="<fmt:formatDate value="${entrevista.fechaEntrevista}" pattern="dd/MM/yyyy"/>"></td>
				</tr>
				<tr>
					<td><label>Lugar Entrevista</label></td>
					<td><input type="text" id="escuela" name="lugarEntrevista"
						size="39" value="${escuelaZona}" class="required" /> <input
						type="hidden" class="required" id="lugarEntrevistaId"
						name="lugarEntrevista.id" value="${entrevista.lugarEntrevista.id}"></input>
						<input id="idProxima" type="hidden" /></td>
				</tr>
				
				<tr>
					<td nowrap="nowrap"><label>Tipo de encuentro de acompañamiento:</label></td>					
						<td>
				...
				<tr>
					...
					<td><form:textarea path="otroMotivoAusenciaRA"
							id="otroMotivoAusenciaRA" rows="4" cols="60" cssStyle="width:98%"
							disabled="true" onblur="chequearLongitud(this);"
							onkeypress="chequearLongitud(this);" /></td>
				</tr>
			</table>
		</td>
	</tr>
