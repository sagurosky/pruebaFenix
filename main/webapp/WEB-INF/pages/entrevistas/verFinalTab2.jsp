...
<table id="table-informe">
	...
	<tr>		
		...
		<td>
			<input type="checkbox"  disabled="true" name="anioAdicional" <c:if test="${alumno.anioAdicional}"> checked="checked" </c:if> 
	...
	<tr>
		...
		<td>
			<form:textarea   disabled="true" path="materiasRendirDiciembre" id="materiasRendirDiciembre" rows="4" cols="30" onblur="chequearLongitud(this);" onkeypress="chequearLongitud(this);"/>
		</td>
	</tr>
	<tr>
		<td nowrap="nowrap"><label>Materias/fechas a rendir en febrero/marzo</label></td>
		<td>
			<form:textarea  disabled="true" path="materiasRendirFebMarzo" id="materiasRendirFebMarzo" rows="4" cols="30" onblur="chequearLongitud(this);" onkeypress="chequearLongitud(this);"/>
		</td>
	</tr>
	...
	<tr>		
		...
		<td>
			<form:input  disabled="true" path="cantidadInasistencias" id="cantidadInasistencias" class="required" onchange="habilitarMotivoInasistencias(this)" onkeypress="return validarDecimal(event, this);"/>
		</td>
	</tr>
	<tr>
		<td nowrap="nowrap"><label>Principales motivos de inasistencias<br>de este período:</label></td>					
		<td>
