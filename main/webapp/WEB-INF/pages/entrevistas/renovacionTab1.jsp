		...
		<td>
			<table id="table-informe">
				<c:if test="${periodo != null && entrevista.periodoDePago == null}">
					<tr>		
						<td nowrap="nowrap"><label>Período Acompañamiento</label></td>
						<td nowrap="nowrap"><label><b>${periodo.nombre}</b></label></td>
					</tr>
				</c:if>
				<c:if test="${entrevista.periodoDePago != null}">
					<tr>		
						<td nowrap="nowrap"><label>Periodo Acompañamiento</label></td>
						<td nowrap="nowrap"><label><b>${entrevista.periodoDePago.nombre}</b></label></td>
					</tr>
				</c:if>
				<tr>
					<td class="datepicker" nowrap="nowrap"><label>Fecha De Incorporación al PFE *</label></td>
					<td nowrap="nowrap"><label><b><fmt:formatDate value="${alumno.fechaPBE}" pattern="dd/MM/yyyy"/></b></label>																
				...
				<tr>
					<td nowrap="nowrap"><label>Principal tipo encuentro acompañamiento:</label></td>					
						<td>
				...
				<tr>
					<td><label>Tuvo más de un Encuentro de acompañamiento en el mes?</label></td>
					<td>
				...
				<tr>	
					<td><label>Participó Becado  *</label> ${entrevista.participoBecado}</td>
					<td>
				...
				<tr>
					...
					<td>
						<form:textarea path="otroMotivoAusencia" class="textbox2" id="otroMotivoAusencia"  rows="4" cols="30" onblur="chequearLongitud(this);" onkeypress="chequearLongitud(this);"/>
					</td>
				</tr>
				<tr>
