...
<div class="row">
		...
		<div class="position-fixed">
			...
			<div class="form-group">				
					<c:if test="${tipoPerfil == 'rr' && boletin=='sinBoletin'}">
						<input type="button" class="btn btn-secondary " disabled="disabled" value="Finalizar" class="ui-state-default ui-corner-all" onclick="guardarAprobar('f','${tipoPerfil}');" />
					</c:if>
	...
	<div class="form-group form-inline">
		<c:choose>
			...
			<c:otherwise>			
				<label>Principales Contenido trabajado &nbsp;&nbsp;</label>
			</c:otherwise>
		</c:choose>	
