	...
	function guardarAprobar(valor, valorPerfil){
		...
		if (document.forms['altaEntrevistaIndividual'].evaluacionCobroBeca.value == 3 ) { 
			...
			if (valor == 'f' || valor == 's'){
				...
				//}else{
				//	jAlert('warning', 'Falta completar Tiene su CV armado ', 'Atención!');  
				//	return false;	
				//}
				...
				//}else{
				//	jAlert('warning', 'Falta completar Tiene mail activo? ', 'Atención!');  
				//	return false;		
				//}
				...
				//  
				//}else{
				//	jAlert('warning', 'Falta completar Usaste el fichero? ', 'Atención!');  
				//	return false;		
				//}
				...
				//}else{
				//	jAlert('warning', 'Falta completar Completaste la brújula? ', 'Atención!');  
				//	return false;		
				//}
				...
				if(document.forms['altaEntrevistaIndividual'].ecabp.value=="0"){			
					jAlert('warning', 'Falta completar Valoración compromiso AB con el Progama ', 'Atención!');  
					return false;	
				}
				...
				if(document.forms['altaEntrevistaIndividual'].sarpepe.value=="0"){			
					jAlert('warning', 'Falta completar Proyección post-escolar del AB ', 'Atención!');  
					return false;	
				}
				...
				if(document.forms['altaEntrevistaIndividual'].corroboradoBoletin.value=="0"){			
					jAlert('warning', 'Falta completar Fue corroboardo con boletín? ', 'Atención!');  
					return false;	
				}
				else{
					//alert(6);
...
<h1 id="titulo-informe">Espacio de acompañamiento Final - ${entrevista.estadoEntrevista.valor}</h1>
