		...
		<td>
			<table id="table-informe">
				...
				<c:if test="${periodo != null && entrevista.periodoDePago == null}">
					<tr>		
						<td nowrap="nowrap"><label>Periodo Espacio de<br>acompañamiento</label></td>
				...
				<tr>
					<td nowrap="nowrap" class="datepicker" ><label>Fecha De Incorporación al PFE</label></td>
				...
				<tr>	
					...
					<td>
						...
						<select id="participoBecado" name="participoBecado">							
							<c:choose>
				...
				<tr>
					...
					<td>
						<form:textarea path="otroMotivoAusencia" id="otroMotivoAusencia"   rows="4" cols="30" onblur="chequearLongitud(this);" onkeypress="chequearLongitud(this);" disabled="false"/>
					</td>
				</tr>
				<tr>
