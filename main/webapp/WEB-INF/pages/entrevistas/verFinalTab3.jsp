...
<table id="table-informe">
	...
	<tr>
	 ...
	 -->
	<tr>
			<td nowrap="nowrap"><label>Valoración compromiso AB<br>con el acompañamiento</label></td>
			<td>
				<select id="ecabp" name="ecabp"  disabled="true">
		...
		<tr>
			<td nowrap="nowrap"><label>Valoración Compromiso RA<br>con el acompañamiento</label></td>
			<td>
				<select id="vcrae" name="vcrae"  disabled="true">
		...
		<tr>
			<td nowrap="nowrap"><label>Evaluación de<br>Propósito anual</label></td>
			<td>
				<form:textarea  disabled="true" path="propositoAnual"  id="propositoAnual" class="textbox2" rows="4" cols="60" onblur="chequearLongitud(this);" onkeypress="chequearLongitud(this);"/>											
			</td>											   		
		</tr>
		<tr>		
			...
			<td>
				...
				<form:select path="situacionCrisis">
					<form:options items="${situacionCrisis}" itemLabel="valor" itemValue="id"  disabled="true"/>				
				</form:select>
		...
		<tr>
			...
			<td>
				<form:textarea  disabled="true" path="osme" rows="4" cols="60" onblur="chequearLongitud(this);" onkeypress="chequearLongitud(this);"/>
			</td>
		</tr>
		<tr>
		<td nowrap="nowrap"><label>Principal habilidad<br>trabajada durante<br>la 2º parte del año</label></td>		
		<td>
			<form:select  disabled="true" path="hsTrabajarAño" id="hsTrabajarAño" class="textbox2"> 
				<c:choose>
		...
		<td>
			<form:select  disabled="true" path="contenidosTrabajarDuranteAnio" id="contenidosTrabajarDuranteAnio" class="textbox2">
				<c:choose>
		...
		<tr>
			...
			<td>
				<form:textarea  disabled="true" path="qtam" rows="4" cols="60" onblur="chequearLongitud(this);" onkeypress="chequearLongitud(this);"/>
	...
	<tr>
		...
		<td>
			<form:select  disabled="true" path="situacionEscolarMergeada" id="resultadoAnioEscolar"  class="required">
	...
	<tr>
		<td nowrap="nowrap"><label>Corroboardo con boletín *</label></td>
		<td>
			<select id="corroboradoBoletin" name="corroboradoBoletin"  disabled="true">
				<c:choose>
	...
	<tr>		
		...
		<td>
			<form:select  disabled="true" path="evaluacionRenovacionFinal" id="evaluacionRenovacionFinal" class="required" onchange="habilitarRenovacion(this)">
				<form:option value="">Seleccione una opción...</form:option>
	...
	<tr>
		...
		<td>
			<form:select  disabled="true" path="motivoNoRenovacion" id="motivoNoRenovacion" class="required">
				<form:option value="">Seleccione una opción...</form:option>
	...
	<tr><td>${alumno.beca.ciclo.nombre+13-alumno.anioEscolar.id}</td></tr>
	<c:if test="${alumno.beca.ciclo.nombre+13-alumno.anioEscolar.id==-1 || alumno.beca.ciclo.nombre+13-alumno.anioEscolar.id==0 || alumno.beca.ciclo.nombre+13-alumno.anioEscolar.id==2019}">
			
			<tr>
				<td  nowrap="nowrap"><label><font color="#AE30CD">Proyección post-escolar del AB</font></label></td>
				<td>	
					<select id="sarpepe" name="sarpepe"  disabled="true">				
			...
			<tr>
				<td  nowrap="nowrap"><label><font color="#AE30CD">En caso que quiera estudiar,<br> qué estudios quiere hacer?</font></label></td>
				<td>	
					<select id="te" name="te"  disabled="true">				
			...
			<tr>
				<td nowrap="nowrap"><label><font color="#AE30CD">Si ya lo tiene definido,<br>especificar carrera y/o institución</font></label></td>
			
			
				
				<td>						
					<form:textarea  disabled="true" path="ie" rows="4" cols="70" onblur="chequearLongitud(this);" onkeypress="chequearLongitud(this);"/>					
				</td>				
			</tr>
			<tr>	
				<td><label><font color="#AE30CD">Tiene su CV armado</font></label></td>
				<td>
					<form:checkbox path="cv" id="cv"  disabled="true" />
				</td>
			</tr>
			<tr>	
				<td><label><font color="#AE30CD">Tiene mail activo?</font></label></td>
				<td>
					<form:checkbox path="tma" id="tma"  disabled="true" />
				</td>
			</tr>
			...
			<tr>
				...
				<td>						
					<form:input  disabled="true" path="dirMail" id="dirMail"  size="70" onblur="chequearLongitud(this);" onkeypress="chequearLongitud(this);"/>					
				</td>				
			</tr>
			<tr>
				<td nowrap="nowrap"><label><font color="#AE30CD">Facebook</font></label></td>
				<td>						
					<form:input  disabled="true" path="facebook" id="facebook" size="70" onblur="chequearLongitud(this);" onkeypress="chequearLongitud(this);"/>					
				</td>				
			</tr>
			<tr>
				<td nowrap="nowrap"><label><font color="#AE30CD">Teléfono fijo</font></label></td>
				<td>						
					<form:input  disabled="true" path="telFijo" id="telFijo" onblur="chequearLongitud(this);" onkeypress="chequearLongitud(this);"/>					
				</td>				
			</tr>
			<tr>
				<td nowrap="nowrap"><label><font color="#AE30CD">Celular</font></label></td>
				<td>						
					<form:input  disabled="true" path="celular" id="celular" onblur="chequearLongitud(this);" onkeypress="chequearLongitud(this);"/>					
				</td>				
			</tr>
		</c:if>	
	...
	<td nowrap="nowrap"><label>Evaluacion Cobro Beca  *</label></td>
		<td>
		<form:select  disabled="true" path="evaluacionCobroBeca" id="evaluacionCobroBeca" class="required" onchange="habilitarMotivos(this)">
			<form:option value="">Seleccione una opción...</form:option>
	...
	<tr>
		...
		<td>
			<form:select  disabled="true" path="motivoSuspension" id="motivoSuspension" class="required"  >
				<form:option value="">Seleccione una opción...</form:option>
	...
	<c:if test="${tipoPerfil != 'ea'}">  
		<tr>		
			...
			<td>
				<form:checkbox  disabled="true" path="pagaEntrevista" checked="checked"/>
			</td>
		</tr>
	</c:if>
	<tr>
		...
		<td>
			<form:textarea  disabled="true" path="comentariosRevision" rows="4" cols="30" onblur="chequearLongitud(this);" onkeypress="chequearLongitud(this);"/>
		</td>
	</tr>
</table>