...
<table id="table-informe">
	...
	<tr>
		...
		<td>
			<form:textarea path="materiasRendirDiciembre" id="materiasRendirDiciembre" rows="4" cols="30" disabled="true"/>
		</td>
	</tr>
	<tr>
		<td nowrap="nowrap"><label>Materias/fechas a rendir en febrero/marzo</label></td>
		<td>
			<form:textarea path="materiasRendirFebMarzo" id="materiasRendirFebMarzo" rows="4" cols="30" disabled="true"/>
		</td>
	</tr>
