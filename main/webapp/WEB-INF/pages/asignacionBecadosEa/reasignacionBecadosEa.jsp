...
<title>Reasignaci&oacute;n de Becados a EAs</title>
...
$(document).ready(function() {
	...
	$('#boton_todos').click( function() {
		...
		oTable2.fnReloadAjax( "../reasignacionBecadosEa/buscarBecados.do");
	})
	
	$('#asignacionForm').submit( function() {
		var becados = fnGetIdsOfSelectedRows(fnGetSelected(oTable2),oTable2);
		var ea = fnGetIdsOfSelectedRows(fnGetSelected(oTable1),oTable1);
		jQuery("#becadosSeleccionados").val(becados);
		jQuery("#idPerfilEA").val(ea);
		if(becados == "" || ea == ""){
	        jAlert('warning', 'Por favor seleccione 1 EA y al menos 1 becado.', 'Atención!');
			return false;
		}
		return true;
	} );
	...
	oTable1 = $('#tabla1').dataTable({
	 ...
	 oTable2 = $('#tabla2').dataTable({
		...
		"sPaginationType": "full_numbers",
		"iDisplayLength": 25,
		"sAjaxSource" : "../reasignacionBecadosEa/buscarBecados.do",
		"aoColumns" : [
					/* idCandidato */{
						"bSortable" : false,
						"bSearchable" : false,
		...
		$('#boton_deseleccionar').click( function() {
			$(oTable2.fnSettings().aoData).each(function (){
				$(this.nTr).removeClass('row_selected');
			});
		})
		 ...
		 $('#tabla1 tbody').delegate('tr', 'click', function(event) {
				...
				oTable2.fnReloadAjax( "../reasignacionBecadosEa/buscarBecados.do?eaId=" + aData[0]  );
			});
		...
		$("thead#ea input").keyup( function () {
			...
			if(isMultipleSeleccion){
				...
				oTable1.fnFilter( this.value, $("thead#ea input").index(this) );
			}
		} );
...
<body>
<div id="main-content">
<form id="asignacionForm" class="asignacionForm"  action="<c:url value='/reasignacionBecadosEa/reasignacionBecadosEa.do' />" method="post">
<br>
<CENTER>
<table style="margin-left: 50px; margin-right: 50px;">
<tr >
<td style="vertical-align: top">
<div class="ui-state-default ui-corner-all" style="width:900px;">
<h3>Reasignaci&oacute;n de Becados a EAs</h3>
</div>
<jsp:include page="/WEB-INF/pages/asignacionBecadosEa/listaBecados.jsp"></jsp:include>

<br />

<jsp:include page="/WEB-INF/pages/asignacionBecadosEa/listaEas.jsp"></jsp:include>
...
<tr>
	<td>
		...
		<!-- input type="button" name="boton_seleccionar_todos" id="boton_seleccionar_todos" value="Seleccionar todos" class="ui-state-default ui-corner-all" /-->
		<!--input type="button" name="boton_deseleccionar" id="boton_deseleccionar" value="Borrar seleccion" class="ui-state-default ui-corner-all" /-->
	</td>
</tr>
</table>

<input type="hidden" id="becadosSeleccionados" name="becadosSeleccionados"/>
<input type="hidden" id="idPerfilEA" name="idPerfilEA"/>
</td>
</tr>
</table>
</CENTER>
