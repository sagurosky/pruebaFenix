...
<title>Asignaci&oacute;n de Becados a EAs</title>
...
$(document).ready(function() {
	...
	$('#boton_todos').click( function() {
		...
		oTable2.fnReloadAjax( "../asignacionBecadosEa/buscarBecados.do");
	})
	...
	oTable1 = $('#tabla1').dataTable({
	 ...
	 oTable2 = $('#tabla2').dataTable({
		...
		"iDisplayLength": 25,
		"bProcessing" : true,
		"sAjaxSource" : "../asignacionBecadosEa/buscarBecados.do",
		"aoColumns" : [
					/* idCandidato */{
						"bSortable" : false,
						"bSearchable" : false,
		...
		$('#tabla2 tbody').delegate('tr', 'click', function(event) {
		 ...
		 $("#tabla1 tbody").delegate('tr', 'click', function(event) {
				...
				oTable2.fnReloadAjax( "../asignacionBecadosEa/buscarBecados.do?eaId=" + aData[0]  );
			});
...
<body>
<div id="main-content">
<form id="asignacionForm" class="asignacionForm"  action="<c:url value='/asignacionBecadosEa/asignacionBecadosEa.do' />" method="post">
<br>
<CENTER>
...
<h3>Asignaci&oacute;n de Becados a EAs</h3>
</div>
