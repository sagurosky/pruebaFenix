		...
		<center>
			<fieldset style="font-size: 12px; width: 980px;">
				...
				<table id="table-informe" align="center"
					...
					<tr align="center">
						<td align="left" style="font-size: 13px; font-weight: bold">Año
							Escolar:</td>
						...
						<td align="left" style="font-size: 13px; font-weight: bold">Situación
							Escolar:</td>
			...
			<br> <br>
			<h5>Este listado tiene una exportación especial a excel que
				incluye la actualización de los datos post PFE<img src="../static/images/atencion.gif" width=10></h5>
		</center>
		<br> <br>
    	...
    	<div style="width: 0.5cm" class="ui-state-default ui-corner-all"
			...
			Femenino
				...
				<display:column property="datosPersonales.telefono" media="excel"
					title="Teléfono"></display:column>
				<display:column property="datosPersonales.mail" title="Email"
					media="excel"></display:column>
				<display:column property="anioEscolar.valor" title="Año Escolar"></display:column>
				<display:column property="eae" title="EAE"></display:column>
				<display:column title="Año Adicional" media="excel">
			...
			${dto.ea.datosPersonales.apellido}, ${dto.ea.datosPersonales.nombre}
				...
				<display:column title="Período Baja">
			...
			No aplica
				...
				<display:column title="Período Egreso">
			...
			${dto.periodoDeEgreso.ciclo.nombre}
				...
				<display:column property="ultimaActualizacion"
					...
					title="Actualización situación escolar"></display:column>
				<display:column title="Situación actual" media="excel">
				...
				<display:column property="otraSituacion" media="excel"
					title="Otra situación actual"></display:column>

				<display:column property="ultimaActualizacion" media="excel"
					format="{0,date,dd-MM-yyyy}"
					title="Ultima actualización de situación actual"></display:column>

				<display:column title="Proyección deseada" media="excel">
				...
				<display:column property="otraProyeccion" media="excel"
					title="Otra proyección deseada"></display:column>
				...
				<display:column property="fechaProyeccionDeseada" media="excel"
					format="{0,date,dd-MM-yyyy}"
					title="Última actualización de proyección deseada"></display:column>
				...
				<table border="0" align="left" cellpadding="0" cellspacing="0">
					...
					<tr>
						<td><span class="ui-icon ui-icon-alert"
							style="float: left; margin: 0 7px 40px 0;">Esta acción
							enviará al alumno al listado de candidatos. Desea continuar?</td>
					</tr>
				</table>
			</div>
		</div>
