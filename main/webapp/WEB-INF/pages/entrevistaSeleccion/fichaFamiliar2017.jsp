...
<table>
		<tr>
			...
			No<input type="radio" id="entrevistaSeleccion.saludBecado" name="entrevistaSeleccion.saludBecado"
			  <c:if test="${entrevistaSeleccionDTO.entrevistaSeleccion.repitio == false}"> checked="checked"</c:if> value="false">			
			</td>
			<td>
			<p><label>Cuales?</label>
...
<table>
	<tr>
		<td>
			...
			<p><font color="green"><label>Egresos Totales *</label></font>
				<input name="perfilAlumno.responsable1.egresosTotales" id="egresosTotalesFicha" class="required digits" 
