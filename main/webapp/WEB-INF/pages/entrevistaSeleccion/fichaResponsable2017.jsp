...
<fieldset>
	...
	<table id="tablaDatosResponsable">
		...
		<tr>
			...
			<td>
				...
				<input name="perfilAlumno.responsable1.fechaNacimiento" id="fechaNacimientoRes" class="date required" value="<fmt:formatDate value="${entrevistaSeleccionDTO.perfilAlumno.responsable1.fechaNacimiento}" pattern="dd/MM/yyyy"/>" onchange="llenarFechaHidden()"> 
				</p>
			</td>
			<td></td>
		</tr>
	...
	<input type="hidden" id="fechaNacRes" name="fechaNacRes"></input>
	<input type="hidden" id="fechaNacRes" name="fechaNacRes"></input>
</fieldset>
...
<!-- Datos generales -->
<fieldset>
	<legend>Evaluación RA</legend>
	<table id="tablaGeneralesResponsable">
		<tr>
			<td colspan="3"></td>
		</tr>
		<tr>
			<td>
				<p>
					<label>Información complementaria</label>
						<form:textarea path="perfilAlumno.responsable1.informacionComplementaria" rows="4" cols="50" id="informacionComplementaria" onblur="chequearLongitudRA(this);" onkeypress="chequearLongitudRA(this);"/>
				</p>
			</td>
			<td></td>
			<td></td>
		...
		<tr>
			<td>
				<p>
					<font color="green"><label>Percepciones sobre el RA *</label></font>
						<form:textarea path="perfilAlumno.responsable1.percepcionesSobreRA" rows="4" cols="50" id="percepcionesSobreRA" 
						onblur="chequearLongitudRA(this);" onkeypress="chequearLongitudRA(this);" class="required"/>
				</p>
			</td>
			<td></td>
			<td></td>
		...
		<tr>
			<td>
				<p>
					<font color="green"><label>Compromiso escolaridad *</label></font>
							<select name="compromisoEscolaridad" id="compromisoEscolaridad" class="required">
								<option value="">Seleccione una opci&oacute;n:</option>
								<c:forEach items="${listCompromiso}" var="compromisoEscolaridad">
									<c:choose>
										<c:when test="${entrevistaSeleccionDTO.perfilAlumno.responsable1.idCompromiso.id == compromisoEscolaridad.id}">
												<option value="${compromisoEscolaridad.id}" selected="selected">${compromisoEscolaridad.valor}</option>
										</c:when>
										<c:otherwise>
												<option value="${compromisoEscolaridad.id}">${compromisoEscolaridad.valor}</option>
										</c:otherwise>	
									</c:choose>
		...
		<tr>
			<td>
				<p>
					<font color="green"><label>Posibilidad compromiso PFE *</label></font>
							<select name="posibilidadCompromisoPBE" id="posibilidadCompromisoPBE" class="required">
								<option value="">Seleccione una opci&oacute;n:</option>
								<c:forEach items="${listPosibilidadCompromisoPBE}" var="posibilidadCompromisoPBE">
									<c:choose>
										<c:when test="${entrevistaSeleccionDTO.perfilAlumno.responsable1.idCompromisoPBE.id == posibilidadCompromisoPBE.id}">
												<option value="${posibilidadCompromisoPBE.id}" selected="selected">${posibilidadCompromisoPBE.valor}</option>
										</c:when>
										<c:otherwise>
												<option value="${posibilidadCompromisoPBE.id}">${posibilidadCompromisoPBE.valor}</option>
										</c:otherwise>	
									</c:choose>								
								</c:forEach>
							</select>
		...
		<tr>
			<td>
				<p>
					<font color="green"><label>Apto como RA *</label></font>
							<select name="aptoComoRA" id="aptoComoRA" class="required">
								<option value="">Seleccione una opci&oacute;n:</option>
								<c:forEach items="${listAptoComoRA}" var="aptoComoRA">
									<c:choose>
										<c:when test="${entrevistaSeleccionDTO.perfilAlumno.responsable1.idAptoComoRA.id == aptoComoRA.id}">
												<option value="${aptoComoRA.id}" selected="selected">${aptoComoRA.valor}</option>
										</c:when>
										<c:otherwise>
												<option value="${aptoComoRA.id}">${aptoComoRA.valor}</option>
										</c:otherwise>	
									</c:choose>								
								</c:forEach>
							</select>
		...
		<tr>			
			<td>
				<p>
					...
					<input type="text" name="identrevistador" id="identrevistador" value="${entrevistaSeleccionDTO.perfilAlumno.responsable1.idEntrevistador }">
