	...
	<table align="left" width="550px">
		<tr>
			...
			<p><font color="green"><label for="fechaEntrevista">Fecha Entrevista:*</label> </font>
				<input name="fechaEntrevista" id="fechaEntrevista"  class="date required" value="<fmt:formatDate value="${entrevistaSeleccionDTO.entrevistaSeleccion.fechaEntrevista}" pattern="dd/MM/yyyy"/>" onChange="calcular_fecha(this.value)"  > 
				<input type="date" name="fechaEntrevista" id="fechaEntrevista"  class="date required" value="<fmt:formatDate value="${entrevistaSeleccionDTO.entrevistaSeleccion.fechaEntrevista}" pattern="dd/MM/yyyy"/>" onChange="calcular_fecha(this.value)"  >
				<input type="text" value="<fmt:formatDate value="${entrevistaSeleccionDTO.entrevistaSeleccion.fechaEntrevista}" pattern="dd/MM/yyyy"/>" onChange="calcular_fecha(this.value)"  >
			</p>
		</td>
		</tr>
		...
		<tr>
			...
			<br>
			<br>
			<p><font color="green"><label style="font-size: 10px"><b>Ingresa al Programa con excepción *</b></label></font> 
				<select name="excepcion" id="excepcion" class="required">
					<c:choose>
    					<c:when test="${entrevistaSeleccionDTO.entrevistaSeleccion.excepcion == 'No'}">
       						<option value=" ">Seleccione una opci&oacute;n:</option>
							<option value="No" selected="selected">No</option>
							<option value="Con Previas">Con Previas</option>
							<option value="Repitente">Repitente</option>	
					    </c:when>
					    <c:when test="${entrevistaSeleccionDTO.entrevistaSeleccion.excepcion == 'Con Previas'}">
					        <option value=" ">Seleccione una opci&oacute;n:</option>
							<option value="No">No</option>
							<option value="Con Previas" selected="selected">Con Previas</option>
							<option value="Repitente">Repitente</option>
					    </c:when>
					    <c:when test="${entrevistaSeleccionDTO.entrevistaSeleccion.excepcion == 'Repitente'}">
							<option value=" ">Seleccione una opci&oacute;n:</option>
							<option value="No">No</option>
							<option value="Con Previas">Con Previas</option>
							<option value="Repitente" selected="selected">Repitente</option>
					    </c:when>
					    <c:otherwise>
						 	<option value=" ">Seleccione una opci&oacute;n:</option>
							<option value="No">No</option>
