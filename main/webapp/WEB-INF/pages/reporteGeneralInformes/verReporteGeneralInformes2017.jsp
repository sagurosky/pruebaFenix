    ...
    <table>
		<tr>
			<td>
				<div  style="width:0.5cm" class="ui-state-default ui-corner-all">  
					<a onclick="enviarForm('verInforme','${listaInformes.id}','${tipoPerfil}')" title="Informe">  
						<span class="ui-icon ui-icon-zoomin" title="Ver Informe"></span>
					</a>
				</div>
			</td>
			<sec:authorize access="hasRole('DI') or hasRole('SYS') or hasRole('SuperUsuario') or hasRole('RR')">
				<c:if test="${listaInformes.tipoInforme == tipoInformeIC && listaInformes.estadoInforme == estadoInformeFin
					&& listaInformes.cicloActual == nombreCicloActual}">
					<td>
						<div  style= width:0.5cm class="ui-state-default ui-corner-all" > 
							<a onclick="enviarForm('editarInforme','${listaInformes.id}','${tipoPerfil}')" title="Informe">   
								<span class="ui-icon ui-icon-pencil" title="Editar Informe"></span>
							</a>				
						</div>
					</td>
				</c:if>
				<c:if test="${listaInformes.tipoInforme == tipoInformeIS2 && listaInformes.estadoInforme == estadoInformeFin
					&& listaInformes.cicloActual == nombreCicloActual}">
					<td>
						<div  style= width:0.5cm class="ui-state-default ui-corner-all" > 
							<a onclick="enviarForm('editarInforme','${listaInformes.id}','${tipoPerfil}')" title="Informe">   
				...
				<c:if test="${listaInformes.tipoInforme == tipoInformeIS3 && listaInformes.estadoInforme == estadoInformeFin
					 && (listaInformes.cicloActual == nombreCicloActual || listaInformes.cicloActual == nombreCicloAnterior)}">
					<td>
						<div  style= width:0.5cm class="ui-state-default ui-corner-all" > 
							<a onclick="enviarForm('editarInforme','${listaInformes.id}','${tipoPerfil}')" title="Informe">   
								<span class="ui-icon ui-icon-pencil" title="Editar Informe"></span>
				...
				<c:if test="${listaInformes.tipoInforme == tipoInformeIS1 && listaInformes.estadoInforme == estadoInformeRevision
					 && listaInformes.cicloActual == nombreCicloActual}">
					<td>
						<div  style= width:0.5cm class="ui-state-default ui-corner-all" > 
							<a onclick="enviarForm('editarInforme','${listaInformes.id}','${tipoPerfil}')" title="Informe">   
				...
				<c:if test="${listaInformes.tipoInforme == tipoInformeFP && (listaInformes.estadoInforme == estadoInformeRevision
					|| listaInformes.estadoInforme == estadoInformePendiente || listaInformes.estadoInforme == estadoInformeFin) 
					&& listaInformes.cicloActual == nombreCicloActual}">
					<td>
						<div  style= width:0.5cm class="ui-state-default ui-corner-all" > 
							<a onclick="enviarForm('editarInforme','${listaInformes.id}','${tipoPerfil}')" title="Informe">   
			...
			<sec:authorize access="hasRole('SuperUsuario') or hasRole('RR')">
				<c:if test="${listaInformes.tipoInforme == tipoInformeIC && listaInformes.estadoInforme == estadoInformeConstruccion
					 && listaInformes.cicloActual == nombreCicloActual}">
					<td>
						<div  style= width:0.5cm class="ui-state-default ui-corner-all" > 
							<a onclick="enviarForm('editarInforme','${listaInformes.id}','${tipoPerfil}')" title="Informe">   
				...
				<c:if test="${listaInformes.tipoInforme == tipoInformeIS2 && listaInformes.estadoInforme == estadoInformeConstruccion
					 && listaInformes.cicloActual == nombreCicloActual}">
					<td>
						<div  style= width:0.5cm class="ui-state-default ui-corner-all" > 
							<a onclick="enviarForm('editarInforme','${listaInformes.id}','${tipoPerfil}')" title="Informe">   
				...
				<c:if test="${listaInformes.tipoInforme == tipoInformeIS3 && listaInformes.estadoInforme == estadoInformeConstruccion
					 && (listaInformes.cicloActual == nombreCicloActual || listaInformes.cicloActual == nombreCicloAnterior)}">
					<td>
						<div  style= width:0.5cm class="ui-state-default ui-corner-all" > 
							<a onclick="enviarForm('editarInforme','${listaInformes.id}','${tipoPerfil}')" title="Informe">   
				...
				<c:if test="${listaInformes.tipoInforme == tipoInformeFP && listaInformes.estadoInforme != estadoInformeEnviado}">
					<td>
						<div style= width:0.75cm class="ui-state-error ui-corner-all" >			 
							<a  onclick="enviarForm('eliminar','${listaInformes.id}','${tipoPerfil}')" > 
								<span class="ui-icon ui-icon-trash" title="Eliminar Informe"></span>
							</a>				
						</div>
					</td>
				</c:if>
