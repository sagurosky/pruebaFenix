...
function verificarEscuela(){
	...
	if (xx>0){
		alert("Ya existe la Escuela que querés dar de alta, por favor verificalo");
		$("#nombre").val("");
		$("#idEscuela").val("");
...
<c:set var="urlRegreso" value="${urlRegreso}"></c:set>
    <fieldset style="width:600px;">
		...
		<table>
			...
			<tr>
				<td><label>Nombre (no usar comillas, ya que todo lo que está después, no se toma)*</label></td>
				<td>
			...
			<tr>
				...
				<td align="right"><label>Cantidad de años *</label></td>
	...
	<br>
	<fieldset style="width:600px;">
		<legend>Información general Cimientos</legend>
		<br></br>
		<p>
		...
		<p>
			<label style="width: 150px">Año comienzo del proyecto</label>
		...
		<p>
			<label style="width: 150px"> Año de comienzo de PFE</label>
