...
<table width="120" border="0" align="left" cellpadding="0" cellspacing="0" id="table-forms">
		...
		<td width="600"><input type="text" id="nuevoCuil" name="cuil" class="text-input required" value="${persona.cuilCuit}"></td>
		</tr>
		<tr>
			<td><label for="mail">e-mail:</label></td>
			<td><input type="text" name="mail" id="mail" class="text-input" value="${persona.mail}"/></td>
		</tr>
		<tr>
        <td>&nbsp;</td>
        <td>&nbsp;</td>
