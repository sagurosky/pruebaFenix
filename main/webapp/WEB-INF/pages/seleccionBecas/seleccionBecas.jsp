...
$(document).ready(function() {
	...
	oTable1 = $('#tabla1').dataTable({
	 ...
	 oTable2 = $('#tabla2').dataTable({
		...
		"iDisplayLength": 25,
		"bProcessing" : true,
		"sAjaxSource" : "../seleccionBecas/buscarAlumnos.do",
		"aoColumns" : [
					/* idCandidato */{
						"bSortable" : false,
						"bSearchable" : false,
	 ...
	 $("#tabla1 tbody").delegate('#beca_row', 'click', function(event) {
			...
			var aData = oTable1.fnGetData( this );
			 oTable2.fnReloadAjax( "../seleccionBecas/buscarAlumnos.do?becaId=" + aData[0]  );
		});
		...
		$('#boton_todos').click( function() {
			...
			oTable2.fnReloadAjax( "../seleccionBecas/buscarAlumnos.do");
		})
...
<body>
<div id="main-content">
<form id="asignacionForm" class="asignacionForm" action="<c:url value='/seleccionBecas/seleccionBecas.do' />" method="post">
<br>
<CENTER>
<table style="margin-left: 50px; margin-right: 50px;">
<tr >
<td style="vertical-align: top">
<div class="ui-state-default ui-corner-all" style="width:800px;">
<h3 align="center">Asignaci&oacute;n de Becas</h3>
</div>

<jsp:include page="/WEB-INF/pages/listasComunes/listaBecasAsignacion.jsp"></jsp:include>

<br />

<jsp:include page="/WEB-INF/pages/listasComunes/listaAlumnosAsignacion.jsp"></jsp:include>
