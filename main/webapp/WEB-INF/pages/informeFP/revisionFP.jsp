...
<h1 id="titulo-informe">PROGRAMA FUTUROS EGRESADOS</h1>
			...
			<table border="0" align="left" cellpadding="0" cellspacing="0"
				...
				<tr>
					<td><textarea id="vosMismo" name="vosMismo" rows=4 cols=100>${ficha.observacionesGenerales}</textarea></td>
				</tr>
				...
				<tr><td><textarea id="observacionesNoIncorporacion" name="observacionesNoIncorporacion" rows=4 cols=100>${ficha.observacionesNoIncorporacion}</textarea></td></tr>	
				...
				<tr><td><textarea id="propositoAnual" name="propositoAnual" rows=4 cols=100>${ficha.propositoAnual}</textarea></td></tr>
