...
<h1 id="titulo-informe">PROGRAMA FUTUROS EGRESADOS</h1>
			...
			<table border="0" align="left" cellpadding="0" cellspacing="0"
				...
				<tr>
					<td><textarea id="cuandoTermine" name="cuandoTermine" rows=4 cols=100>${ficha.cuandoTermine}</textarea>
...
<tr>
				...
				<tr>
					<td><label>El Programa se implementa desde:</label> ${ficha.becado.escuela.comienzoPBE.nombre}<br><br></td>
