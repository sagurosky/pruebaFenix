...
<title>Informes Seguimiento Nº 1 a Corregir</title>
...
function enviarForm(action, id){
	...
	if(action=='correccion'){
		document.forms['informeForm'].action = "../informeIS1/verInformeIS1CorrectoraView.do";
	}
...
<form id="informeForm" class="informeForm" action="<c:url value='/informeIS1/verInformeIS1CorrectoraView.do' />" method="post">
	<center>
		<h1>
			Listado Informes Seguimiento Nº 1 a Corregir
		</h1>
	</center>
	<br/>
	<CENTER>
