...
<title>Informes Seguimiento Nº 1 a Revisar</title>
...
function enviarForm(id){
	...
	document.forms['informeForm'].action = "../informeIS1/verInformeIS1RevisionView.do";
...
<body>
<div id="main-content">
<form id="informeForm" class="informeForm" action="<c:url value='/informeIS1/verInformeIS1RevisionView.do' />" method="post">
	<center>
		<h1>
			Listado Informes Seguimiento Nº 1 a Revisar 
		</h1>
	</center>
	<br/>
	<CENTER>
