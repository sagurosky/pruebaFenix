...
function enviarForm(action){
	...
	if(action == 'corregir'){
		document.forms['informeForm'].action = "../informeIS1/actualizarInformeSupervisor.do?accion=" + action;
		$.blockUI();
		$('#informeForm').submit();
	}
	if(action == 'guardar'){
		if (document.forms['informeForm'].informacionSuspension != null) {
			if (document.forms['informeForm'].informacionSuspension.value == "") { 
			      jAlert('warning', 'El campo "Suspensión" no puede estar vacio', 'Atención!');
...
<h1 id="titulo-informe">:: Informe de Seguimiento Nº 1 ::</h1>
    <table border="0" align="left" cellpadding="0" cellspacing="0" id="table-informe">
		...
		<!-- tr>
			<td><a href="">Edición de datos del alumno</a></td>
		</tr-->
		<tr>
			<td>&nbsp;</td>
			<td>&nbsp;</td>
		...
		<table width="200" border="0" align="left" cellpadding="0" cellspacing="0" id="table-forms"> 
      	<tr>
			<td width="600"><label>Observaciones sobre materías y exámenes:</label></td>
			<td width="600"><form:textarea rows="5" cols="60" path="observacionMateriasExamenes"></form:textarea></td>
		</tr>
		<tr>
      	    <td>&nbsp;</td>
      	    <td>&nbsp;</td>
		...
		<table width="200" border="0" align="left" cellpadding="0" cellspacing="0" id="table-forms"> 
		<tr>
			<td valign="top" width="600"><label>Escolaridad y compromiso durante el año anterior:</label></td>
		...
		<tr>
			<td valign="top"><label>Observaciones entrevista de renovación:</label></td>
		...
		<tr>
			<td valign="top"><label>Suspensión:</label></td>
		...
		<tr>
      	...
      	<tr>
			<td colspan="2"><h1 id="subtitulo-informe">Comentarios de Revisión</h1></td>
		</tr>
      	...
      	<tr>
 	       <td colspan="2">
             ...
             <tr>
              ...
              <td width="50" height="0" align="center" valign="middle">
              	<input class="ui-state-default ui-corner-all" type="button" onclick="enviarForm('revisar')" value="Revisar" />
              </td>
              <td width="50" height="0" align="center" valign="middle">
              	<input class="ui-state-default ui-corner-all" type="button" onclick="enviarForm('corregir')" value="Correctora" />
              </td>
