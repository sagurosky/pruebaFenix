...
<title>Reasignaci&oacute;n Becas</title>
...
$(document).ready(function() {
	...
	$('#boton_todos').click( function() {
		...
		oTable2.fnReloadAjax( "../reasignacionBecas/buscarAlumnos.do");
	})
	...
	$('#asignacionForm').submit( function() {
		...
		if(becaSeleccionada == "" || alumnosSeleccionados == ""){
	...
	$.blockUI({ message: "<h1>Espere por favor...</h1>" }); 
	 oTable2 = $('#tabla2').dataTable({
		...
		"iDisplayLength": 25,
		"bProcessing" : true,
		"sProcessing": "Buscando, espere por favor...",
		"sAjaxSource" : "../reasignacionBecas/buscarAlumnos.do",
		"oLanguage" : {
			"sUrl" : "../static/js/config_tabla.txt"
			},
	 ...
	 $("#tabla1 tbody").delegate('#beca_row', 'click', function(event) {
			...
			var aData = oTable1.fnGetData( this );
			 oTable2.fnReloadAjax( "../reasignacionBecas/buscarAlumnos.do?becaId=" + aData[0]  );
...
<body>
<div id="main-content">
<form id="asignacionForm" class="asignacionForm" action="<c:url value='/reasignacionBecas/reasignacionBecas.do' />" method="post">
<br>
<CENTER>
...
<h3 align="center">Reasignaci&oacute;n Becas</h3>
</div>
<jsp:include page="/WEB-INF/pages/reasignacionBecas/listaAlumnosReasignacion.jsp"></jsp:include>
<br />
