...
<title>Informe de Cesacion a Revisar</title>
		...
		if (document.forms['supervisionInformeCesacion'].detallePagosSuspendidos != null) {
			if (document.forms['supervisionInformeCesacion'].detallePagosSuspendidos.value == "") { 
			      ...
			      document.forms['supervisionInformeCesacion'].detallePagosSuspendidos.focus();
					...
					document.forms['supervisionInformeCesacion'].action = "../informeCesacion/actualizarInformeRevision.do?accion=" + action;
					$.blockUI();
			...
			<td>
				<table>
					...
					<tr>
						...
						<td><input name="materiasAprobadas" id="materiasAprobadas" type="text" disabled="disabled" onkeypress="return soloNumeros(event);" value="${materiasAprobadas}" class="required numeric text-input"></input></td>
					</tr>
					<tr>
						<td><label>Materias desaprobadas</label></td>
						<td><input name="materiasDesaprobadas" id="materiasDesaprobadas" type="text" disabled="disabled" onkeypress="return soloNumeros(event);" value="${materiasDesaprobadas}" class="required numeric text-input"></input></td>
					</tr>
					<tr>
						<td><label>Inasistencias</label></td>
						<td><input name="inasistencias" id="inasistencias" type="text" disabled="disabled"  onkeypress="return validarDecimal(event, this);" value="${inasistencias}" class="required text-input"></input></td>
					</tr>
					<tr>
						<td><label>Observaciones de bolet&iacute;n</label></td>
						<td colspan="2"><textarea cols="60" rows="5" disabled="disabled" name="obsBoletin" id="obsBoletin" onblur="chequearLongitud(this);" onblur="chequearLongitud(this);" onkeypress="chequearLongitud(this);">${obsBoletin}</textarea></td>
					</tr>
				</table>
			</td>
		</tr>		
      	...
      	<tr>
 	       <td colspan="2">
             ...
             <tr>
		  	  ...
		  	  <td width="50" height="0" align="center" valign="middle">
		  	  	<input class="ui-state-default ui-corner-all " onclick="enviarForm('finalizar')"  type="button" value="Finalizar" />
		  	  </td>	  
			  <td width="50" align="center" valign="middle">
			  	<input type="button" value="Volver" class="ui-state-default ui-corner-all" 
		       	onclick="location.href='../informes/listaInformesConstruccion.do'; return false;"/>
		       </td>
