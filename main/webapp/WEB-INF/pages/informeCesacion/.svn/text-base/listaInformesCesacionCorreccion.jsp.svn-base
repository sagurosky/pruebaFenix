...
<title>Informes Cesación en Corrección</title>
...
function enviarForm(action, id){
	...
	if(action=='correccion'){
		document.forms['cesacionForm'].action = "../informeCesacion/corregirView.do";
	}
...
<body>
<div id="main-content">
<form id="cesacionForm" class="cesacionForm" action="<c:url value='/informeCesacion/correccion.do' />" method="post">
	<center>
		<h3>
			Lista de Informes en Corrección
		</h3>
	</center>
	<br/>
	<CENTER>
								...
								<tr>
									<td>
										<div  style= width:0.5cm class="ui-state-default ui-corner-all" > 
											<a  onclick="enviarForm('correccion','${i.id}')">
