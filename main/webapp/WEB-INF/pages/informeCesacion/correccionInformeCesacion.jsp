...
<title>Informe de Cesacion a Corregir</title>
...
function enviarForm(action){
	...
	if(action == 'finalizar'){
		document.forms['supervisionInformeCesacion'].action = "../informeCesacion/actualizarInformeCorrectora.do?accion=" + action;
		$.blockUI();
      	...
      	<tr>
 	       <td colspan="2">
             ...
             <tr>
		  	  ...
		  	  <td width="50" height="0" align="center" valign="middle">
		  	  	<input class="ui-state-default ui-corner-all " onclick="enviarForm('supervisar')"  type="button" value="Supervisar" />
		  	  </td>	
		  	  <td width="50" height="0" align="center" valign="middle">
