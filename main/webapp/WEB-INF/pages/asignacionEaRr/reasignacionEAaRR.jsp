...
<title>Reasignaci&oacute;n de EAs a RR</title>
...
$(document).ready(function() {
	...
	$('#boton_todos').click( function() {
		...
		oTable2.fnReloadAjax( "../reasignacionEaRr/buscarEAs.do");
	})
	...
	oTable1 = $('#tabla1').dataTable({
	 ...
	 oTable2 = $('#tabla2').dataTable({
		...
		"iDisplayLength": 25,
		"bProcessing" : true,
		"sAjaxSource" : "../reasignacionEaRr/buscarEAs.do",
		"aoColumns" : [
					/* idCandidato */{
						"bSortable" : false,
						"bSearchable" : false,
	 ...
	 $("#tabla1 tbody").delegate('tr', 'click', function(event) {
			...
			oTable2.fnReloadAjax( "../reasignacionEaRr/buscarEAs.do?rrId=" + aData[0]  );
		});
...
<body>
<div id="main-content">
<form id="asignacionForm" class="asignacionForm"  action="<c:url value='/reasignacionEaRr/reasignacionEaRr.do' />" method="post">
<br>
<CENTER>
...
<h3>Reasignaci&oacute;n de EAs a RR</h3></div>
<jsp:include page="/WEB-INF/pages/asignacionEaRr/listaEAsReasignacion.jsp"></jsp:include>
