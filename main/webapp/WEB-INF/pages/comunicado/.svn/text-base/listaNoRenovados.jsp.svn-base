...
<title>Lista de Comunicados de No Renovación</title>
...
function enviarForm(id){
	...
	document.forms['informeForm'].action = "../comunicado/verNoRenovacionView.do";
...
<form id="informeForm" class="informeForm" action="" method="post">
	...
	<td style="vertical-align: middle;" align="center">
		...
		<h3 align="center">Listado de Comunicados de No Renovación</h3>
		</div>
		<!-- Fin titulo -->
		<table class="dataTables_wrapper" width="630px" border="0" id="laTabla" style="background-color: #C0C2FF"> 
			...
			<tbody align="center">
				<c:forEach items="${norenovados}" var="i">
					<tr>
								...
								<tr>
									<td>
										<div  style= width:0.5cm class="ui-state-default ui-corner-all" > 
											...
											<span class="ui-icon ui-icon-pencil" title="Comunicado No Renovación"> 
											</span></a>				
										</div>
									</td>
								</tr>
