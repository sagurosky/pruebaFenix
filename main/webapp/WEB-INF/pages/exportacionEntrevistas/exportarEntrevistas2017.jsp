...
<display:table  class="displayTags_wrapper" style="font-size: 12px; margin-left: 0px; margin-right: 0px;width:1100px; background-color: #C0C2FF;"  id="listaEntrevistas" name="listaEntrevistas" requestURI="" pagesize="50" >  
    ...
    <display:column headerClass="sortable" title="Padrino">	   
		...
		<table>
			<tr>
				...
				<sec:authorize access="hasRole('SuperUsuario') or hasRole('CPBE') or hasRole('SEL') or hasRole('DI') or hasRole('RR') " >
      			...
      			<sec:authorize access="hasRole('SuperUsuario') or hasRole('RR')">
					<c:if test="${listaEntrevistas.estadoEntrevista.valor != estadoEntrevistaFin}">
						<td>
							<div  style= width:0.5cm class="ui-state-default ui-corner-all" > 
