...
<display:table name="convocados"  class="displayTags_wrapper" id="dto"  export="true" style="font-size: 12px; margin-left: 50px; margin-right: 50px;width:1000px; background-color: #C0C2FF;"  pagesize="50" defaultsort="50" defaultorder="ascending" requestURI="" >
	...
	<display:column property="estadoAlumnoEntrevista.valor"   title="Estado Entrevista Selección" ></display:column>
	<display:column property="nombreConvocatoria" title="Última Convocatoria" ></display:column>
	<display:column property="apellidoNombreTS" title="TS Designado" ></display:column>
	<display:column property="motivoEnvioTS.valor" title="Motivo envío Visita" ></display:column>
	<display:column property="recomendacionesTS.valor" title="Recomendación TS" ></display:column>
