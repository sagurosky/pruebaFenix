...
<c:set var="urlRegreso" value="${urlRegreso}"></c:set>
    <table border="0" align="left" cellpadding="0" cellspacing="0" id="table-informe">
   	 	<tr>
			<td><label>Construcción - Mod</label></td>
		</tr>
		<tr>
			<td>&nbsp;</td>
		</tr>
			...
			<td>
				<table width="200" border="0" align="left" cellpadding="0" cellspacing="0" id="table-forms"> 
					<tr>
						...
						<td>
							<textarea  cols="50" rows="5"  class="required" name="mensajePadrino" onblur="eliminarEnter(this);chequearLongitudTextarea(this,1800);" 
		...
		<tr>
			<td colspan="2">
				<label>
					Debido al cambio de formato del IS2 la cantidad máxima de caracteres que podrás escribir en este campo es 1800.
				</label>
			</td>
		</tr-->
		<!-- tr>
