...
<title>Supervision de Informe de Seguimiento Nro 2</title>
...
function enviarForm(action, idIS2, idBecado){
	...
	if(action =='correccion'){
		document.forms['supervisarInformeIS2'].action = "../informeIS2/correccion.do";
		$.blockUI();
		$('#supervisarInformeIS2').submit();
	}
	if(action == 'construccion'){
		if (document.forms['supervisarInformeIS2'].suspensiones != null) {
			if (document.forms['supervisarInformeIS2'].suspensiones.value == "") { 
			      jAlert('warning', 'El campo "Suspensiones de la Beca" no puede estar vacio', 'Atención!');
			      document.forms['supervisarInformeIS2'].suspensiones.focus();
				}else{
					document.forms['supervisarInformeIS2'].action ="../informeIS2/modificarIS2.do";
					$.blockUI();
					document.forms['supervisarInformeIS2'].submit();
				}
		}else{	
			document.forms['supervisarInformeIS2'].action ="../informeIS2/modificarIS2.do";
			$.blockUI();
		...
		if (document.forms['supervisarInformeIS2'].suspensiones != null) {
			if (document.forms['supervisarInformeIS2'].suspensiones.value == "") { 
			      ...
			      document.forms['supervisarInformeIS2'].suspensiones.focus();
					...
					document.forms['supervisarInformeIS2'].action ="../informeIS2/supervisionGuardar.do";
					$.blockUI();
					document.forms['supervisarInformeIS2'].submit();
				}
		}else{
	...
	document.forms['supervisarInformeIS2'].idAlumno.value = idBecado;
	document.forms['supervisarInformeIS2'].idInformeIS2.value = idIS2;
...
<body>
<div id="main-content">
<form id="supervisarInformeIS2" class="cmxform" action="" method="post">
<h1 id="titulo-informe">:: Informe de Seguimiento Nº 2 ::</h1>
    <table border="0" align="left" cellpadding="0" cellspacing="0" id="table-informe">
		...
		<tr>
			...
			<td colspan="2"><textarea cols="60" rows="5" name="obsBoletin" class="required" onblur="chequearLongitud(this);" onblur="chequearLongitud(this);" onkeypress="chequearLongitud(this);">${obsBoletin}</textarea></td>
		</tr>
		</table>
		</td>
		</tr>
      	...
      	<tr>
 	       <td colspan="2">
             ...
             <tr>
		  	  ...
		  	  <td width="55" height="0" align="center" valign="middle">
		  	  	<input class="ui-state-default ui-corner-all " onclick="enviarForm('construccion','${idInformeIS2}','${becado.id}')" type="button" value="Revisar" />
		  	  </td>	
		  	  <td width="55" height="0" align="center" valign="middle">
		  	  	<input class="ui-state-default ui-corner-all " onclick="enviarForm('correccion','${idInformeIS2}','${becado.id}')" type="button" value="Correctora" />
		  	  </td>		  
