...
<title>Corrección Informes Seguimiento Nº2</title>
...
function enviarForm(action, id){
	...
	if(action=='correccion'){
		document.forms['IS2Form'].action = "../informeIS2/correccionInformeIS2View.do";
	}
...
<form id="IS2Form" class="IS2Form" action="" method="post">
	<center>
		<h1>
			Listado Informes Seguimiento Nº 2 pendientes de Corrección 
		</h1>
	</center>
	<br/>
	<CENTER>
								...
								<tr>
									<td>
										<div  style= width:0.5cm class="ui-state-default ui-corner-all" > 
											...
											<span class="ui-icon ui-icon-pencil" title="Informe IS2"> 
											</span></a>				
										</div>
									</td>
								</tr>
