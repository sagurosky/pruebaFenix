...
<div id="right-content">
	...
	<fieldset>
		<legend>Datos de Padrino</legend>
		    <table width="90" border="0" align="left" cellpadding="0" cellspacing="0" id="table-forms">
				...
				<tr>
					<td>Nº Ctes Plataforma Contable</td>
	...
	<table width="90" border="0" align="left" cellpadding="0" cellspacing="0" id="table-forms">
		...
		<tr>
        <td>Fecha de alta</td>
        <td><input id="fechaAlta2" name="fechaAlta2"  value="<fmt:formatDate value="${padrino.empresa.fechaAlta}" pattern="dd/MM/yyyy"/>" /> dd/mm/aaaa</td>
	    </tr>		
	</table>
	</fieldset>
