...
<c:if test="${vacio == true}">
	<c:set var="action" value="registrar2.do"></c:set>
</c:if>
<c:if test="${vacio == false}">
	<c:set var="action" value="modificar2.do"></c:set>
</c:if>
<form:form id="altaUsuario" modelAttribute="usuario" commandName="usuario"
	...
	<div id="tabs">
		...
		<div id="tabs-1">
			<jsp:include page="fichaUsuario/datosUsuario2.jsp"></jsp:include>
		</div>
		<div id="tabs-2">
			<jsp:include page="fichaUsuario/datosPersona2.jsp"></jsp:include>
		</div>
