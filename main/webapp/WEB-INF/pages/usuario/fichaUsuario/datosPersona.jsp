...
<fieldset>
	...
	<table style="margin-left: 20px;" border="0" align="left" cellpadding="0" cellspacing="0">
		...
		<tr>
			...
			<td>
			<form:input path="persona.cuilCuit" id="cuil" readonly="true"/></td>
		</tr>
		<tr>
	    	<td height="10px"></td>
	    	<td></td>
	...
	<table style="margin-left: 20px;" border="0" align="left" cellpadding="0" cellspacing="0">
		<tr>
	        ...
	        <td><input type="checkbox" name="rolEA" id="rolEA" 
		       	<c:if test="${usuario.persona.perfilEA.idPerfilEA != null && usuario.persona.perfilEA.activo}"> checked="checked"</c:if>></input></td>	        
	    </tr>
	    <tr>
	        <td><label>RR</label></td>
	        <td><input type="checkbox" name="rolRR" id="rolRR" 
	        	<c:if test="${usuario.persona.perfilRR.idPerfilRR != null && usuario.persona.perfilRR.activo}"> checked="checked"</c:if>></input></td>
	    </tr>
	    <tr>
	        <td><label>TS</label></td>
	        <td><input type="checkbox" name="rolTS" id="rolTS" 
	        	<c:if test="${usuario.persona.perfilTS.idPerfilTS != null && usuario.persona.perfilTS.activo}"> checked="checked"</c:if>></input></td>
	    </tr>
	    <!-- 
	    <tr>
