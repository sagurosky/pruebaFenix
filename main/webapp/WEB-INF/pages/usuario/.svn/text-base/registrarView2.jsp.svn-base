...
<body>
<div id="main-content">
<form id="altaUsuario" class="cmxform" action="<c:url value='/usuario/registrar2.do' />" method="post">
<h1>Alta de Usuario</h1>
    <table width="120" border="0" align="left" cellpadding="0" cellspacing="0" id="table-forms">
		...
		<tr>
	        ...
	        <td><input type="checkbox" name="perfilEA" readonly="readonly" ></input></td>
	    </tr>
	    <tr>
	        <td><label>RR</label></td>
	        <td><input type="checkbox" name="perfilRR" readonly="readonly"></input></td>
	    </tr>
	    <tr>
	        <td><label>TS</label></td>
	        <td><input type="checkbox" name="perfilTS" readonly="readonly"></input></td>
	    </tr>
	    <tr>
	        <td><label>Selector</label></td>
	        <td><input type="checkbox" name="perfilSelector" readonly="readonly"></input></td>
	    </tr>
	    <tr>
	        <td><label>DI</label></td>
	        <td><input type="checkbox" name="perfilDI" readonly="readonly"></input></td>
	    </tr>
	    <tr>
	        <td><label>Visita</label></td>
	        <td><input type="checkbox" name="perfiVisita" readonly="readonly"></input></td>
	    </tr>
	    <tr>
	        <td><label>Super Usuario</label></td>
	        <td><input type="checkbox" name="perfilSuperUsuario" readonly="readonly"></input></td>
	    </tr>
	    <tr>
	        <td><label>Administracion</label></td>
	        <td><input type="checkbox" name="perfilAdmin" readonly="readonly"></input></td>
	    </tr>
	    <tr>
	        <td><label>Coordinador PFE</label></td>
	        <td><input type="checkbox" name="perfilCoordPBE" readonly="readonly"></input></td>
	    </tr> 
	    <tr>
	        <td><label>Voluntario</label></td>
	        <td><input type="checkbox" name="perfilVoluntario" readonly="readonly"></input></td>
	    </tr>
	    <tr>
	        <td><label>Corrector</label></td>
	        <td><input type="checkbox" name="perfilCorrector" readonly="readonly"></input></td>
	    </tr>
	    <tr>
	        <td><label>Admin</label></td>
	        <td><input type="checkbox" name="perfilSysAdmin" readonly="readonly"></input></td>
	    </tr>
	    <tr>
	    	<td>&nbsp;</td>
	        <td>&nbsp;</td>
