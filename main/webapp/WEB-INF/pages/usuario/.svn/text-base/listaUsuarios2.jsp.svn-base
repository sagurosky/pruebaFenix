...
function enviarForm(action, id,usuario){
	if(action=='modificar'){
		document.forms['usuarioForm'].action = "../usuario/registrarView2.do";
...
<table align="center"  class="dataTables_wrapper" id="laTabla" width="100%" cellspacing="1">
		...
		<tbody align="center">
			<!-- c:forEach items="${usuarios}" begin="0" end="1" var="usuario"-->
				<tr>
					<td align="center" valign="middle" style="font-size: 14px">&nbsp;${usuarios.usuario}&nbsp;</td>
					<td align="center" valign="middle" style="font-size: 14px">&nbsp;${usuarios.persona.apellido}, ${usuarios.persona.nombre}&nbsp;</td>
					<td align="center" valign="middle" style="font-size: 14px">&nbsp;${usuarios.persona.nombrePerfiles}&nbsp;</td>
					<c:choose>
						<c:when test="${usuarios.activo}">
					...
					<td align="center" valign="middle" style="font-size: 14px">
						<table>
						<tr>
							<c:if test="${usuarios.activo}">
								<td align="center" valign="middle">
									<div  style= width:0.5cm class="ui-state-default ui-corner-all" > 
										<a  onclick="enviarForm('modificar','${usuarios.id}','${usuarios.usuario}')" title="Editar Usuario"> 
								...
								<!-- td>
									<div  style= width:0.5cm class="ui-state-default ui-corner-all" > 
										<a  onclick="enviarForm('eliminar','${usuarios.id}','${usuarios.usuario}')" title="Desactivar Usuario"> 
							...
							<c:if test="${!usuarios.activo}">
								<td>
									<div  style= width:0.5cm class="ui-state-default ui-corner-all" > 
										<a  onclick="enviarForm('activar','${usuarios.id}','${usuarios.usuario}')" title="Activar Usuario"> 
