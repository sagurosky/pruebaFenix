							...
							<td>
								<table width="800">	
									<tr>
										...
										<td colspan="2" align="left"><textarea cols="50" rows="5"  name="obsPostPBE" id="obsPostPBE" onkeypress="chequearLongitud(this);" 
												onblur="chequearLongitud(this);">${perfilAlumno.obsPostPBE}</textarea></td>	
									</tr>
								</table>
							</td>
						</tr>
