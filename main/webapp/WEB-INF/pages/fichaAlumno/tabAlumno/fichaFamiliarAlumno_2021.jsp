...
<table id="tablaFicha" border="0" width="100%" style="font-size: x-small" cellspacing="1" cellpadding="1">
		...
		<thead align="center">
			<tr>
				...
				<th width="150px">&nbsp;Motivo de abandono / repitencia&nbsp;</th>
				<th width="150px">&nbsp;(Si trabaja) Nombre de la ocupacion&nbsp;</th>
				<th width="150px">&nbsp;Estabilidad Laboral&nbsp;</th>
				<th width="150px">&nbsp;Remuneración&nbsp;</th>
				<th width="150px">&nbsp;Otros Ingresos(jubilacion/pension/AuxHijo)&nbsp;</th>
			</tr>
		</thead>
			...
			<c:choose>
				...
				<c:otherwise>
					...
					<tr id="fila1">
							...
							<td align="left" valign="middle" style="font-size: 12px;"><input type="text" name="abandonoRepitenciaFichas" value=""></td>
