    ...
    <table border="0" align="left" cellpadding="0" cellspacing="0" id="table-informe">
		...
		<!--tr>
			...
			<td colspan="2">
				...
				<jsp:include page="/WEB-INF/pages/informes/boletinViewis3.jsp"></jsp:include>
			</td>
			</tr>			
			...
			<tr>			
				<td colspan="2">
					<jsp:include page="/WEB-INF/pages/informes/previasViewis3.jsp"></jsp:include>
				</td>
			</tr>
			<tr>
			...
			<td>
				<table width="200" border="0" align="left" cellpadding="0" cellspacing="0" id="table-forms"> 
					...
					<tr>
						<td colspan="2">
							<label>
								Debido al cambio de formato del is3, ya no completaremos este campo
							</label>
						</td>
					</tr>
				</table>
