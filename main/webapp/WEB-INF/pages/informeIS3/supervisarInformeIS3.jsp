...
<title>Supervision de Informe de Seguimiento Nro 3</title>
...
function submiter(){
	...
	document.forms['supervisarInformeIS3'].submit();
}

function enviarForm(action, idIS3, idBecado){
	
	if(action == 'correccion'){
		document.forms['supervisarInformeIS3'].action = "../informeIS3/correccion.do";
		...
		$('#inasistencias').removeAttr("disabled");
		$('#obsBoletin').removeAttr("disabled");
		$('#supervisarInformeIS3').submit();
	}
	if(action == 'revision'){
		if (document.forms['supervisarInformeIS3'].suspensiones != null) {
			if (document.forms['supervisarInformeIS3'].suspensiones.value == "" ) { 
			      jAlert('warning', 'El campo "Suspensiones de la Beca" no puede estar vacio', 'Atención!');
			      document.forms['supervisarInformeIS3'].suspensiones.focus();
				}else{
					document.forms['supervisarInformeIS3'].action ="../informeIS3/modificarIS3.do?action=" + action;
					submiter();
				}
		}else{
			document.forms['supervisarInformeIS3'].action ="../informeIS3/modificarIS3.do?action=" + action;
		...
		if (document.forms['supervisarInformeIS3'].suspensiones != null) {
			if (document.forms['supervisarInformeIS3'].suspensiones.value == "" ) { 
			      ...
			      document.forms['supervisarInformeIS3'].suspensiones.focus();
					...
					document.forms['supervisarInformeIS3'].action ="../informeIS3/supervisionGuardar.do";
					submiter();
				}
		}else{
			document.forms['supervisarInformeIS3'].action ="../informeIS3/supervisionGuardar.do";
	...
	document.forms['supervisarInformeIS3'].idAlumno.value = idBecado;
	document.forms['supervisarInformeIS3'].idInformeIS3.value = idIS3;
...
<div id="main-content">
<form id="supervisarInformeIS3" class="cmxform" action="" method="post">
...
<input type="hidden" id="estadoEntrevista" name="estadoEntrevista" value="${estadoEntrevista}"></input>
  <table border="0" align="left" cellpadding="0" cellspacing="0" id="table-informe">
		...
		<tr>
			...
			<td><input name="materiasAprobadas" type="text" onkeypress="return soloNumeros(event);" disabled="disabled" id="materiasAprobadas" value="${materiasAprobadas}" class="required numeric text-input"></input></td>
		</tr>
		<tr>
			<td><label>Materias desaprobadas</label></td>
			<td><input name="materiasDesaprobadas" type="text" onkeypress="return soloNumeros(event);" disabled="disabled" id="materiasDesaprobadas" value="${materiasDesaprobadas}" class="required numeric text-input"></input></td>
		</tr>
		<tr>
			<td><label>Inasistencias</label></td>
			<td><input name="inasistencias" type="text" onkeypress="return validarDecimal(event, this);" disabled="disabled" id="inasistencias" value="${inasistencias}" class="required numeric text-input"></input></td>
		</tr>
		<tr>
			<td><label>Observaciones de bolet&iacute;n</label></td>
			<td colspan="2"><textarea cols="60" rows="5" class="required" name="obsBoletin" id="obsBoletin" disabled="disabled" onblur="chequearLongitud(this);" onblur="chequearLongitud(this);" onkeypress="chequearLongitud(this);">${obsBoletin}</textarea></td>
		</tr>
		<tr>
		...
		<tr>
			<td colspan="2"><textarea cols="60" rows="5" name="evalRenovacionBeca" id="evalRenovacionBeca" disabled="disabled" onblur="chequearLongitud(this);" onkeypress="chequearLongitud(this);">${evalRenovacionBeca}</textarea></td>
		</tr>
		...
		<tr>
			<td colspan="2"><textarea cols="60" rows="5" name="motivoNoRenovacion" id="motivoNoRenovacion" disabled="disabled" onblur="chequearLongitud(this);" onkeypress="chequearLongitud(this);">${motivoNoRenovacion}</textarea></td>
		</tr>
		...
		<c:choose>
			...
			<c:when test="${estadoEntrevista != 'Finalizada' }">
				...
				<tr>
					<td colspan="2"><textarea cols="60" rows="5" id="situacionRenovacion" name="situacionRenovacion" disabled="disabled" onblur="chequearLongitud(this);" onkeypress="chequearLongitud(this);">${situacionRenovacion}</textarea></td>
				</tr>
			</c:when>
		</c:choose>
		...
		<c:choose>
			<c:when test="${ evalRenovacionBeca == 'Fin participación PFE' && estadoEntrevista == 'Finalizada'}">
				...
				<tr>
				   	<td colspan="2"><textarea cols="60" rows="5" id="observaciones" name="observaciones" onblur="chequearLongitud(this);" onkeypress="chequearLongitud(this);">${observaciones}</textarea></td>
				</tr>
			</c:when>
			<c:when test="${evalRenovacionBeca == 'Fin participación PFE' && estadoEntrevista != 'Finalizada'}">
				<tr>
				...
				<tr>
				   	<td colspan="2"><textarea cols="60" rows="5" id="observaciones" name="observaciones"  disabled="disabled" onblur="chequearLongitud(this);" onkeypress="chequearLongitud(this);">${observaciones}</textarea></td>
				</tr>
			</c:when>
		</c:choose>
     	...
     	<tr>
      	...
      	<tr>
 	       <td colspan="2">
             ...
             <tr>
		  	  <td width="55" height="0" align="center" valign="middle">
		  	  	<input class="ui-state-default ui-corner-all "  onclick="enviarForm('guardar','${idInformeIS3}','${becado.id}')" type="button" value="Guardar" />
		  	  </td>	
		  	  <td width="55" height="0" align="center" valign="middle">
		  	  	<input class="ui-state-default ui-corner-all " onclick="enviarForm('revision','${idInformeIS3}','${becado.id}')" type="button" value="Revisar" />
		  	  </td>	
		  	  <td width="55" height="0" align="center" valign="middle">
		  	  	<input class="ui-state-default ui-corner-all " onclick="enviarForm('correccion','${idInformeIS3}','${becado.id}')" type="button" value="Corrección" />
		  	  </td>		  
