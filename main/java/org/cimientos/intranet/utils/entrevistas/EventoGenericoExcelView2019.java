...
public class EventoGenericoExcelView2019 extends AbstractExcelView{
	...
	private void crearFila(EventoGenericoDTO e, ExportacionEspecialHelper exportacionHelper, HSSFRow row) {
		...
		row.createCell(18).setCellValue(e.getOp1());
		row.createCell(19).setCellValue(e.getOp2());
		row.createCell(20).setCellValue(e.getOp3());
		row.createCell(21).setCellValue(e.getOp5());
		row.createCell(22).setCellValue(e.getOp6());
		row.createCell(23).setCellValue(e.getOp4());
		row.createCell(24).setCellValue(e.getOp());
	}
