				        ...
				        while (rs.next()) {
				        	...
				        	if(ic.getAnioAdicional().equals("Si")){
				        		...
				        		if(rs.getString("eae").equals("6/6")){				
				    				...
				    				if(ic.getAnioEscolar().equals("7º técnica")){
				    					posibleAnioEgreso=Long.parseLong(ciclo.getNombre())+0;
				    				}
				    			}
				    		}
