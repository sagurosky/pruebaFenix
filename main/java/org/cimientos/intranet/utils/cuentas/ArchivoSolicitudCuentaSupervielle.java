 ...
 *
 */
public class ArchivoSolicitudCuentaSupervielle extends ArchivoCuenta{
	...
	private String nombreHoja = "Supervielle";
	
	public ArchivoSolicitudCuentaSupervielle(List<ResponsableAdulto> responsables,/* List<PerfilStaff> staff, */ CicloPrograma cicloActual) {
		super();
