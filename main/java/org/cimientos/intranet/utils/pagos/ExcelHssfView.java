...
public class ExcelHssfView implements BinaryExportView
{
    ...
    {
    	//si es un double 
    	if(Formateador.isDouble(value.toString())){
    		String formattedDouble = StringUtils.replaceChars(value.toString(), ',', '.');
			Double valor = Double.parseDouble( formattedDouble);
		    cell.setCellValue(valor);
    	}else if(StringUtils.isNotBlank(value.toString()) && StringUtils.isNumeric(value.toString())){ // si es un integer o long
