...
public class MateriaDaoImpl extends SpringHibernateDao<Materia> implements MateriaDao{
	...
	public List<Materia> obtenerMateriasBasicas(boolean traerBasicas) {
		...
		criteria.add(Restrictions.disjunction()
		        .add(Restrictions.eq("nombre", "Calificación de Matemática"))
		        .add(Restrictions.eq("nombre", "Calificación de Lengua/ Literatura"))
		        .add(Restrictions.eq("nombre", "Cantidad total de materias en el boletín"))
